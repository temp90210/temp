...
namespace Fonade.FONADE.evaluacion
{
    public partial class ReporteSectores : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!String.IsNullOrEmpty(Session["idConvocatoriaEval"].ToString()))
                {
                    ...
                    idCodSector = Session["idCIIUEval"].ToString();
                    idViable = Session["idViable"].ToString();
        ...
        private void datosGenerales()
        {
            ...
            sql = "SELECT  SUM([Puntaje]) AS PUNTAJE FROM [Fonade].[dbo].[ConvocatoriaCampo] AS CC, [Fonade].[dbo].[Campo] AS C WHERE [id_Campo] = CC.[codCampo] AND C.[codCampo] IS NULL AND [codConvocatoria] = " + idConvocatoriaEval;
            ...
            sql = "SELECT YEAR([FechaInicio]) AS FECHA FROM [Fonade].[dbo].[Convocatoria] WHERE [Id_Convocatoria] = " + idConvocatoriaEval;
            ...
            sql = "SELECT [SalarioMinimo] FROM [Fonade].[dbo].[SalariosMinimos] WHERE [AñoSalario] = " + AnioSalario;
