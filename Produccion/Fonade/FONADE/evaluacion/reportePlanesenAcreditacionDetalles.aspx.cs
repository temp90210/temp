...
namespace Fonade.FONADE.evaluacion
{
    public partial class reportePlanesenAcreditacionDetalles : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (String.IsNullOrEmpty(Session["idNombreConvocatoriaS"].ToString()))
                {
                    Response.Redirect("reportePlanesenAcreditacion.aspx");
                }
                else
                {
                    L_NomConvocatoria.Text = Session["idNombreConvocatoriaS"].ToString();

                    SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ApplicationServices"].ToString());
                    SqlCommand cmd = new SqlCommand("select * from convocatoria where Id_Convocatoria = " + Session["idConvocatoriaEvalS"].ToString(), conn);
        ...
        private void llenarDatatable()
        {
            ...
            using (var con = new SqlConnection(conexionStr))
            {
                using (var com = con.CreateCommand())
                {
                    ...
                    com.Parameters.AddWithValue("@_ConvocatoriaID", Session["idConvocatoriaEvalS"].ToString());
        ...
        protected void B_Excel_Click(object sender, EventArgs e)
        {
            ...
            //fichero.FileName = "planesenacreditacionconvocatoria" + Session["idconvocatoriaevals"].ToString();
        ...
        private void exportar(Table TablaExportar)
        {
            ...
            Response.AddHeader("Content-Disposition", "inline;filename=planesenacreditacionconvocatoria" + Session["idconvocatoriaevals"].ToString() + ".xls");
            Response.Charset = "";
