...
namespace Fonade.FONADE.interventoria
{
    public partial class FrameProduccionInter : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string interno_CodProduccion = Session["interno_CodProduccion"] != null && !string.IsNullOrEmpty(Session["interno_CodProduccion"].ToString()) ? Session["interno_CodProduccion"].ToString() : "0";
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (usuario.CodGrupo != Constantes.CONST_Interventor)
                    {
                        ...
                        catch { gv_productos.Columns[5].Visible = true; }
                    }
                }
        ...
        protected void gv_productos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "mostrar")
            {
                ...
                Session["CodProduccion"] = valores_command[0];
                Session["NombreDelProductoSeleccionado"] = valores_command[1];
                #endregion
            ...
            if (e.CommandName == "insumos")
            {
                ...
                Session["s_CodProduccion"] = valores_command[0];
                Session["s_NombreProducto"] = valores_command[1];
                Session["s_CodProyecto"] = valores_command[2];
        ...
        private void CargarDetalle(string parametros)
        {
            ...
            if (!string.IsNullOrEmpty(variables.ToString()))
            {
                ...
                try
                {
                    ...
                    Session["interno_CodProduccion"] = variables[0].ToString();
        ...
        void DynamicCommand_VerAvance(Object sender, CommandEventArgs e)
        {
            try
            {
                ...
                Session["Accion"] = valores_command[0];
                Session["proyecto"] = valores_command[1];
                Session["CodProduccion"] = valores_command[2];
                //Ya se le está enviado la nómina seleccionada en una variable de sesión.
                Session["MesDelProductoSeleccionado"] = valores_command[3].ToString();
                //Ya se le está enviando el nombre del cargo seleccionado en una variable de sesión.
                Session["pagina"] = "Producción";
                                        ...
                                        else
                                        {
                                            if (String.IsNullOrEmpty(rsTipo2.Rows[0]["ObservacionesInterventor"].ToString()))
                                            {
                                                ...
                                                if (mes_data <= prorrogaTotal)
                                                {
                                                    ...
                                                    img_Elim_VerAvance.ImageUrl = "~/Images/icoAdicionarUsuario.gif";
                                            ...
                                            if (mes_data <= prorrogaTotal)
                                            {
                                                ...
                                                img_Edt_VerAvance.CommandArgument = "actualizar" + ";" + Cod_Proyecto + ";" + Cod_Produccion + ";" + mes_data + ";" + CodProducto;
                                                ...
                                                lnk_Edt_VerAvance.CommandArgument = "actualizar" + ";" + Cod_Proyecto + ";" + Cod_Produccion + ";" + mes_data + ";" + CodProducto;
