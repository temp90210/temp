<%@ Page Language="C#" Title="Fondo Emprender - Agendar Tarea" MasterPageFile="~/Master.master"
    ...
    Inherits="Fonade.FONADE.Tareas.TareasAgendar" EnableSessionState="True" %>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                ...
                                <asp:DropDownList Width="180px" ID="ddl_usuarios" runat="server" ValidationGroup="crearTarea"
                                    DataValueField="Id_Tarea" DataTextField="Nombre_Tarea" DataSourceID="ldscontacto">
                                </asp:DropDownList>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                ...
                                <ajaxToolkit:CalendarExtender runat="server" ID="calExtender2" PopupButtonID="btnDate2"
                                    CssClass="ajax__calendar" TargetControlID="txtDate2" Format="dd/MM/yyyy" />
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
