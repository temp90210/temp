...
namespace Fonade.FONADE.interventoria
{
    public partial class CatalogoInterventor : Negocio.Base_Page
    {
            ...
            foreach (GridViewRow grd_Row in this.gvcGerenteInterventor.Rows)
            {
                try
                {
                    ...
                    if (lnk.Text.Equals("Inactivo"))
                    {
                        ...
                        ((ImageButton)grd_Row.FindControl("ibtninactivar")).Visible = false;
                    }
                    else
                    {
                        ((ImageButton)grd_Row.FindControl("ibtninactivar")).Visible = true;
                        ((ImageButton)grd_Row.FindControl("ibtnreactivar")).Visible = false;
                    }
                }
        ...
        protected void gvcGerenteInterventor_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "vercuantos":
                    Session["ContactoInterventor"] = e.CommandArgument.ToString();
                ...
                case "verestador":
                    ...
                    Session["ContactoInterventor"] = enviarsesion;
                ...
                case "inactivarcoorEval":
                    ...
                    Session["ContactoInterventor"] = enviarsesion2;
                    Redirect(null, "DesactivaInterventor.aspx", "_blank", "menubar=0,scrollbars=1,width=710,height=400,top=100");
                    break;
                ...
                case "editacontacto":
                    ...
                    Session["NombreContactoSeleccionado"] = lnkbtn2.Text;
                    Session["CodContacto_Seleccionado"] = e.CommandArgument.ToString();
                    ...
                    { Session["Accion_Interventor"] = "Nuevo"; }
                    else
                    { Session["Accion_Interventor"] = "vacio"; /*Quiere decir que es para crear datos...*/ }
                ...
                case "verhabilitado":
                    ...
                    Session["CodContacto_Seleccionado"] = palabras[0];
                    Session["NombreContactoSeleccionado"] = palabras[1];
                ...
                case "Estado_Activo_Inactivo":
                    ...
                    Session["ContactoInterventor"] = enviarsesion23;
                    Redirect(null, "DesactivaInterventor.aspx", "_blank", "menubar=0,scrollbars=1,width=710,height=400,top=100");
                    break;
                default:
                    break;
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (hdf_Inactivo != null && hdf_Cuantos != null && hdf_Inhabilitado != null && lnkbtn_cuantos != null && btn_inhabilitado != null && lnk_estado != null)
                {
                    ...
                    else
                    {
                        ...
                        catch (Exception ex) { string em = ex.Message; /*Todo bien.*/}
                        #endregion
                    }
                    ...
                    catch (Exception ex) { string err = ex.Message; /*Todo bien*/ }
        ...
        protected void gvcGerenteInterventor_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                gvcGerenteInterventor.DataSource = Session["dtEmpresas"];
                gvcGerenteInterventor.DataBind();
            }
        }
