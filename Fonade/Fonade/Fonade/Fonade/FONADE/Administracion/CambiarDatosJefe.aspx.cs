    ...
    public partial class CambiarDatosJefe : Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    CodJefeUnidadSeleccionado = Session["codJefeUnidad"] != null ? CodJefeUnidadSeleccionado = Convert.ToInt32(Session["codJefeUnidad"].ToString()) : 0;
        ...
        protected void Btn_Actualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (validado.Trim() == "")
                {
                    ...
                    try { CodJefeUnidadSeleccionado = Convert.ToInt32(Session["codJefeUnidad"].ToString()); }
                    catch
                    {
                    ...
                    { Session["bRepetido"] = "true"; /*Si sí trajo, es porque había un jefe unidad "segun FONADE clásico".*/ }


                    //Mostrar mensaje.
                    if (Session["bRepetido"].ToString() == "true")
                    {
