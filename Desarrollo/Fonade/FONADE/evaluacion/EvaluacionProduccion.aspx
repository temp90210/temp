<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EvaluacionProduccion.aspx.cs"
    Inherits="Fonade.FONADE.evaluacion.EvaluacionProduccion" %>
...
<body>
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <div id="div_Post_It1" runat="server" visible="false">
                        <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="Produccion" _txtTab="1" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 60%;">
                    <div style="width: 670px; text-align: right; overflow: auto;">
                        <table style="width: 100%; text-align: center;" cellpadding="4" cellspacing="1">
                            <tr>
                                <td colspan="13">
                                </td>
                            </tr>
    ...
    <script type="text/javascript">
        $("#<%=GV_ProyectoProducto.ClientID %> [id*='btnRedirect']").click(function (event) {
            event.preventDefault();
            $.fn.windowopen('../evaluacion/InsumoProducto.aspx?Aporte=' + $(this).attr('idproducto'), 400, 200, 'no', 1, 'no');
        });
    </script>
</body>
</html>
