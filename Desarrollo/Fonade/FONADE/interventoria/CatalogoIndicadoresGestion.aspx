            ...
            <tr>
                <td>
                    <asp:GridView ID="gvindicadoresgestion" runat="server" CssClass="Grilla" Width="100%"
                        ...
                        AllowPaging="True" OnPageIndexChanging="gvindicadoresgestion_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button ID="btncatalogointer" runat="server" Text="Ir" CommandArgument='<%# "EDITAR" + ";" + Eval("CodProyecto") + ";" + Eval("id_indicadorinter") %>'
                                        CssClass="boton_Link_Grid" CommandName="EDITAR" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
