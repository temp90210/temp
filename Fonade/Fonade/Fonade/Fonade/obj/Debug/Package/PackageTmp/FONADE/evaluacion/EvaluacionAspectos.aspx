<%@ Page Title="FONDO EMPRENDER" Language="C#" MasterPageFile="~/Emergente.Master" AutoEventWireup="true"
    CodeBehind="EvaluacionAspectos.aspx.cs" Inherits="Fonade.FONADE.evaluacion.EvaluacionAspectos" %>

<%@ Register Src="~/Controles/Post_It.ascx" TagPrefix="uc1" TagName="Post_It" %>
<%--<%@ Register Src="~/Controles/CtrlCheckedProyecto.ascx" TagPrefix="ucchecked" TagName="checked1" %>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    <%--<ucchecked:checked1 runat="server" ID="chedk1"></ucchecked:checked1>--%>
    <!--PRIBAR SI SÍ QUEDÓ PUBLICADO-->
    <table>
        <tbody>
            <tr>
                <td>
        ...
        <tr>
            ...
            <td>
                <div id="div_Post_It" runat="server" visible="false">
                    <uc1:Post_It runat="server" ID="Post_It" _txtCampo="" _txtTab="1" />
                </div>
            </td>
        </tr>
    </table>
                                    ...
                                    <table id="Table4" runat="server" width="100%">
                                        <tr>
                                            ...
                                            <td align="center" style="width: 10%">
                                                ...
                                                <asp:DropDownList ID="DdlpuntajeMedio" runat="server" AutoPostBack="True" Visible="False"
                                                    Width="80%">
