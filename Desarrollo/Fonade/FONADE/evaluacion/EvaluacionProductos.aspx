                        ...
                        <tr>
                            ...
                            <td>
                                <div id="div_Post_It1" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="IndicadoresGestion" _txtTab="1" />
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td>
                    ...
                    &nbsp;<asp:LinkButton ID="B_AgregarIndicador" runat="server" Text="Agregar Indicador"
                        Font-Bold="true" OnClick="B_AgregarIndicador_Click" Visible="false" />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:GridView ID="GV_Indicador" runat="server" Width="100%" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="GV_Indicador_RowCommand">
                        <Columns>
