<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoVentasPOInterventoria.aspx.cs"
    Inherits="Fonade.FONADE.evaluacion.CatalogoVentasPOInterventoria" %>
...
<body>
    ...
    <div>
        <table class="auto-style1">
            ...
            <tr>
                <td style="text-align: center">
                    <asp:Label ID="Label6" runat="server" Text="Ventas:" />
                    <asp:TextBox ID="txt_ventas_obtenidas" runat="server" />
                </td>
                <td style="text-align: center">
                    <asp:Label ID="Label7" runat="server" Text="Ingreso:" />
                    <asp:TextBox ID="txt_ingreso_obtenido" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td style="text-align: center;" colspan="2">
                    ...
                    <asp:ImageButton ID="img_btn_enlazar_grilla_PDF" ImageUrl="../../Images/icoClip2.gif"
                        runat="server" OnClick="img_btn_enlazar_grilla_PDF_Click" />
                </td>
            </tr>
        </table>
    </div>
