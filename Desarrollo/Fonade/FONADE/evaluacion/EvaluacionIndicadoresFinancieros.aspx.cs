    ...
    public partial class EvaluacionIndicadoresFinancieros : Negocio.Base_Page
    {
        ...
        protected void gv_evaluacionindicadores_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modificar")
            {
                ...
                Session["CodAporte"] = idCapital[0];
                Session["AccionAporteEvaluacion"] = "Modificar";
                Session["Descripcion_Loaded"] = idCapital[1];
        ...
        public DataTable sp_EvaluacionProyectoIndicador_SelectAll(int codProyecto, int codConvocatoria)
        {
            ...
            txtSQL = " SELECT id_indicador, Descripcion, Tipo, Valor, Protegido FROM EvaluacionProyectoIndicador WHERE codProyecto = " + codProyecto + " AND codConvocatoria = " + codConvocatoria;
        ...
        {
            Session["CodAporte"] = 0;
            Session["AccionAporteEvaluacion"] = "Crear";
        ...
        { prActualizarTabEval(Constantes.ConstSubIndicadoresFinancieros.ToString(), codProyecto, codConvocatoria); Marcar(Constantes.ConstSubIndicadoresFinancieros.ToString(), codProyecto, codConvocatoria, chk_realizado.Checked); ObtenerDatosUltimaActualizacion(); }
        ...
        protected void gv_evaluacionindicadores_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lnk_2 != null && img != null)
                {
                    ...
                    if (!estaProtegido && usuario.CodGrupo == Constantes.CONST_Evaluador && !bRealizado)
                    {
