...
namespace Fonade.FONADE.interventoria
{
    public partial class DescargarCoord : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Id_Acta = Session["Id_Acta"] != null && !string.IsNullOrEmpty(Session["Id_Acta"].ToString()) ? Session["Id_Acta"].ToString() : "0";
                ...
                if (!string.IsNullOrEmpty(Id_Acta))
                {
                    ...
                    var result = (from pa in consultas.Db.MD_DetalleSolicitudesPago(Convert.ToInt32(Id_Acta)) select pa);
        ...
        {
            Session["Id_PagoActividad"] = e.CommandArgument;
