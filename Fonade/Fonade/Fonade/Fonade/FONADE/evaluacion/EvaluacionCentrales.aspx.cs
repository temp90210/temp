...
namespace Fonade.FONADE.evaluacion
{
    public partial class EvaluacionCentrales : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            bRealizado = esRealizado(Constantes.ConstSubCentralesRiesgo.ToString(), codProyecto, "");
            ...
            { this.div_observaciones.Visible = true; }
        ...
        { prActualizarTabEval(Constantes.ConstSubCentralesRiesgo.ToString(), codProyecto, codConvocatoria); Marcar(Constantes.ConstSubCentralesRiesgo.ToString(), codProyecto, codConvocatoria, chk_realizado.Checked); ObtenerDatosUltimaActualizacion(); }
