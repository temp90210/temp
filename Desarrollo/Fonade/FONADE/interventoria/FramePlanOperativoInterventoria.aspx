        ...
        <div id="divadicionar" runat="server">
            <table style="width: 50%">
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="lnkPagos" runat="server" OnClick="lnkPagos_Click">Pagos</asp:LinkButton>
                    </td>
                    <td>
                ...
                <td align='left' valign='top' width='98%'>
                    ...
                    <table cellpadding="0px" cellspacing="0px">
                        <tr>
                            <td valign="Top" style="height: 590px !important;">
                                <div style="height: auto !important; width: 420px; overflow: auto; overflow-x: hidden;
                                    ...
                                    <asp:GridView ID="gw_Anexos" runat="server" Width="400px" AutoGenerateColumns="false"
                                        ...
                                        OnRowDataBound="GwAnexosRowDataBound" AllowPaging="True">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkeliminar" runat="server" OnClientClick="return alerta()" CommandArgument='<%# Eval("id_Actividad") %>'
                                    ...
                                    <asp:Panel runat="server" ID="pnlActividades">
                                        <asp:GridView ID="GrvActividadesNoAprovadas" runat="server" Width="400px" AutoGenerateColumns="False"
                                            ...
                                            BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowPaging="True" OnPageIndexChanging="GrvActividadesNoAprovadas_PageIndexChanging">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                    </ItemTemplate>
                            ...
                            <td valign="Top">
                                <div style="width: 438px; overflow: auto; height: 295px !important;">
                                    <table id="tabla_meses" class="Grilla" cellpadding="0" cellspacing="0" width="500px"
                                        ...
                                        <tr>
                                            <th style="width: 260px; text-align: center">
                                                <asp:Label runat="server" ID="lblnomactividad" />
                                            </th>
                                        </tr>
                                    </table>
                                    <%--<asp:GridView ID="gw_AnexosActividad" runat="server" Width="3380px" AutoGenerateColumns="False"
                                        ...
                                        OnRowCommand="gw_AnexosActividad_RowCommand">
                                        <Columns>
