...
namespace Fonade.FONADE.interventoria
{
    public partial class CatalogoCumpliInformeInter : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                s_hdf_CodInforme = Session["s_hdf_CodInforme"] != null && !string.IsNullOrEmpty(Session["s_hdf_CodInforme"].ToString()) ? Session["s_hdf_CodInforme"].ToString() : "0";
                s_hdf_CodItem = Session["s_hdf_CodItem"] != null && !string.IsNullOrEmpty(Session["s_hdf_CodItem"].ToString()) ? Session["s_hdf_CodItem"].ToString() : "0";
                s_hdf_CodEmpresa = Session["s_hdf_CodEmpresa"] != null && !string.IsNullOrEmpty(Session["s_hdf_CodEmpresa"].ToString()) ? Session["s_hdf_CodEmpresa"].ToString() : "0";
