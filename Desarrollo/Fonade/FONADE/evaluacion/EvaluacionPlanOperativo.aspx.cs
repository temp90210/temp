    ...
    public partial class EvaluacionPlanOperativo : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                bRealizado = esRealizado(Constantes.CONST_subPlanOperativoEval.ToString(), codProyecto.ToString(), "");
        ...
        private void ObtenerDatosUltimaActualizacion()
        {
            ...
            try
            {
                ...
                txtSQL = " SELECT Nombres + ' ' + Apellidos AS nombre, FechaModificacion, Realizado " +
                         ...
                         " WHERE Id_Contacto = CodContacto AND CodTabEvaluacion = " + Constantes.CONST_subPlanOperativoEval +
        ...
        { prActualizarTabEval(Constantes.CONST_subPlanOperativoEval.ToString(), codProyecto, codConvocatoria); Marcar(Constantes.CONST_subPlanOperativoEval.ToString(), codProyecto, codConvocatoria, chk_realizado.Checked); ObtenerDatosUltimaActualizacion(); }
