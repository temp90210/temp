...
namespace Fonade.FONADE.interventoria
{
    ...
    public partial class FrameNominaInter : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Nómina seleccionada.
            string interno_CodNomina = Session["interno_CodNomina"] != null && !string.IsNullOrEmpty(Session["interno_CodNomina"].ToString()) ? Session["interno_CodNomina"].ToString() : "0";
            if (interno_CodNomina != "0")
            {
                //t_anexos = new Table();
                //Llamar a método para activar botón.

                GenerarTabla(interno_CodNomina, CodProyecto.ToString(), Session["EsCargo"].ToString());
            }
            #endregion
        ...
        protected void gv_personalCalificado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "editar")
            {
                ...
                Session["proyecto"] = CodProyecto;
                Session["CodNomina"] = e.CommandArgument.ToString(); //Estaba "Session["CodProducto"]".
                Session["pagina"] = "Nomina";
                Session["v_Tipo"] = "Cargo";
            ...
            if (e.CommandName == "mostrar")
            {
                ...
                Session["CodNomina"] = valores_command[0];
                Session["NombreDelCargo"] = valores_command[1];
                Session["EsCargo"] = "Cargo";
                #endregion
        ...
        private void CargarDetalle(string parametros)
        {
            ...
            if (!string.IsNullOrEmpty(variables.ToString()))
            {
                ...
                Session["interno_CodNomina"] = variables[0].ToString();
                GenerarTabla(variables[0], CodProyecto.ToString(), Session["EsCargo"].ToString());
                #endregion*/
            }
        }
        ...
        private List<Double> Listado_TotalAvances(List<Int32> L_Nominas, List<Int32> LCodTipoFinanciacion)
        {
            ...
            {
                sqlConsulta = "SELECT * FROM [Fonade].[dbo].[AvanceCargoPOMes] WHERE [CodCargo] = " + L_Nominas[i] +
                ...
                if (usuario.CodGrupo == Constantes.CONST_Interventor)
                {
                    ...
                    if (result.CodCoordinador == 0) //No existe
                    {
                        ...
                        sqlConsulta = "INSERT INTO InterventorNominaTMP (id_nomina, CodProyecto, Tipo, Tarea) " +
                                      "VALUES (" + P_CodNomina + ", " + CodProyecto + ", 'Cargo' ,'Borrar') ";
                        ...
                        if (procesado) //Si es TRUE, el proceso debe seguir normal, si no sale nada, toca revisar el código.
                        {
                            ...
                            if (procesado)
                            {
                                //Generar tareas... Ver línea 758 de Declaravariables.inc "el método está comentado".

                                System.Web.UI.ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Mensaje", "alert('Personal seleccionado eliminado.')", true);
                                CargarGridPersonalCalificado();
                                return;
                            }
                        }
                                            ...
                                            else
                                            {
                                                if (rsPagoActividad.Rows.Count == 0)
                                                {
                                                    ...
                                                    if (mes_data <= prorrogaTotal)
                                                    {
                                                        ...
                                                        lnk_EdtAvance.CommandArgument = "actualizar" + ";" + Cod_Proyecto + ";" + Cod_Nomina + ";" + mes_data + ";" + nomCargo;
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (mes_data <= prorrogaTotal)
                                                    {
                                                        ...
                                                        lnk_VerAvance_Again.CommandArgument = "actualizar" + ";" + Cod_Proyecto + ";" + Cod_Nomina + ";" + mes_data + ";" + nomCargo;
                                    ...
                                    else
                                    {
                                        ...
                                        if (usuario.CodGrupo != Constantes.CONST_Interventor)
                                        {
                                            ...
                                            if (mes_data <= prorrogaTotal)
                                            {
                                                ...
                                                img_VerAvance.CommandArgument = "actualizar" + ";" + Cod_Proyecto + ";" + Cod_Nomina + ";" + mes_data + ";" + nomCargo;
                                                ...
                                                lnk_VerAvance.CommandArgument = "actualizar" + ";" + Cod_Proyecto + ";" + Cod_Nomina + ";" + mes_data + ";" + nomCargo;
                                    ...
                                    else
                                    {
                                        ...
                                        if (usuario.CodGrupo != Constantes.CONST_Interventor)
                                        {
                                            ...
                                            if (mes_data <= prorrogaTotal)
                                            {
                                                ...
                                                img_Repo_Avance.CommandArgument = "crear" + ";" + Cod_Proyecto + ";" + Cod_Nomina + ";" + mes_data + ";" + nomCargo;
                                                ...
                                                lnk_Repo_Avance.CommandArgument = "crear" + ";" + Cod_Proyecto + ";" + Cod_Nomina + ";" + mes_data + ";" + nomCargo;
