      ...
      <div>
        ...
        <ajaxToolkit:TabContainer ID="tc_proyectos" runat="server" ActiveTabIndex="0" Width="100%"
            ...
            <ajaxToolkit:TabPanel ID="tc_observaciones" OnDemandMode="Once" runat="server" Width="100%"
                Height="100%">
                <HeaderTemplate>
                    <div class="tab_header"  id="dividentificacion" onclick="CargarPestana('frmIdentificacion','EvaluacionFinanciera.aspx?txtTab=1')">
            ...
            <ajaxToolkit:TabPanel ID="tc_generales" runat="server" Width="100%" Height="100%">
                <HeaderTemplate>
                    <div class="tab_header" onclick="CargarPestana('frmGenerales','EvaluacionFinanciera.aspx?txtTab=4')">
            ...
            <ajaxToolkit:TabPanel ID="tc_frmcomercial" runat="server" Width="100%" Height="100%">
                <HeaderTemplate>
                    <div class="tab_header" onclick="CargarPestana('frmcomercial','EvaluacionFinanciera.aspx?txtTab=15')">
