    ...
    public partial class CatalogoVentasAprobar_TMP : Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["Accion"].ToString().Equals("actualizar")) { B_Acion.Text = "Actualizar"; lbl_enunciado.Text = "Consultar"; L_Item.Visible = false; TB_Item.Visible = false; TB_Item.Text = "Default"; BuscarDatos_Ventas(); B_Acion.Visible = false; }
        ...
        private void BuscarDatos_Ventas()
        {
            ...
            if (usuario.CodGrupo == Constantes.CONST_CoordinadorInterventor || usuario.CodGrupo == Constantes.CONST_GerenteInterventor)
            {
                sqlConsulta = " SELECT * FROM [Fonade].[dbo].[InterventorVentasMesTMP] " +
                              " WHERE [Fonade].[dbo].[InterventorVentasMesTMP].[CodProducto] = " + codProduccion + " " +
                              " ORDER BY [Fonade].[dbo].[InterventorVentasMesTMP].[Tipo], " +
                              " [Fonade].[dbo].[InterventorVentasMesTMP].[Mes] ";
            }
            else
            {
                if (usuario.CodGrupo == Constantes.CONST_Interventor)
        ...
        //        if (usuario.CodGrupo == Constantes.CONST_CoordinadorInterventor || usuario.CodGrupo == Constantes.CONST_GerenteInterventor)
        //        {
        //            sqlConsulta = "SELECT * FROM [Fonade].[dbo].[InterventorVentasMes] WHERE [CodProducto] = " + codProduccion + " ORDER BY Mes";
        ...
        //        if (usuario.CodGrupo == Constantes.CONST_CoordinadorInterventor || usuario.CodGrupo == Constantes.CONST_GerenteInterventor)
        //        {
        //            sqlConsulta = "SELECT * FROM [Fonade].[dbo].[InterventorVentasMesTMP] WHERE [CodProducto] = " + codProduccion + " ";
