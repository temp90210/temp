        ...
        <table class="auto-style1">
            ...
            <tr>
                <td style="text-align: center">
                    <asp:LinqDataSource ID="ldsmemorandoempresas" runat="server" ContextTypeName="Datos.FonadeDBDataContext" AutoPage="true" OnSelecting="ldsmemorandoempresas_Selecting"></asp:LinqDataSource>
                    <asp:GridView ID="gv_MemorandoEmpresas" runat="server" Width="400px" AutoGenerateColumns="false" DataSourceID="ldsmemorandoempresas"
                        CssClass="Grilla" AllowPaging="True" AllowSorting="true" OnRowCommand="gv_MemorandoEmpresas_RowCommand"
                        PageSize="30" OnPageIndexChanging="gv_MemorandoEmpresas_PageIndexChanging" OnRowDataBound="gv_MemorandoEmpresas_RowDataBound">
