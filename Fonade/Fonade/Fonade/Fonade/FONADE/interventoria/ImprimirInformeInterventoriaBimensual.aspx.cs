...
namespace Fonade.FONADE.interventoria
{
    public partial class ImprimirInformeInterventoriaBimensual : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            idInformeBimensual = Session["INF_idInformeBimensual"] != null ? idInformeBimensual = Session["INF_idInformeBimensual"].ToString() : "0";

            if (!IsPostBack)
            {
                //Obtener el valor enviado desde la página "AdicionarInformeBimensual.aspx".
                if (idInformeBimensual == "0")
                { idInformeBimensual = Session["idInformeBimensual"] != null ? idInformeBimensual = Session["idInformeBimensual"].ToString() : "0"; }
