<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsignacionCoordinadorEvaluador.aspx.cs" Inherits="Fonade.FONADE.evaluacion.AsignacionCoordinadorEvaluador"  MasterPageFile="~/Master.Master"  %>
        ...
        <ContentTemplate>
            ...
            <table width="100%">
              <tr>
                ...
                <td class="auto-style3" valign="baseline"><strong>Seleccione un Evaluador:</strong></td>
            ...
            <table width="100%">
              <tr>
                ...
                <td class="auto-style6" align="center">
                    ...
                    <asp:GridView ID="gvcoorAsigando"  CssClass="Grilla" runat="server" DataSourceID="lds_CoordAignado" 
                        ...
                        EmptyDataText="Aún no hay un coordinador asignado para este evaluador." >
                        <Columns>
                            <asp:TemplateField HeaderText="Coordinador de Evaluador" >
                                <ItemTemplate>
                                    <asp:Label ID="lcoordinador" runat="server" Text='<%# Eval("Nombre") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
              ...
              <tr>
                ...
                <td class="auto-style11" align="center">
                    ...
                    <asp:Button ID="btn_asignar" runat="server" Text="Asignación de Coordinador a Evaluador" OnClick="btn_asignar_Click" />
             ...
             <table width="100%">
               <tr>
                ...
                <td class="auto-style18" style="text-align: center;">
                        ...
                        <h2>
                    Coordinadores de Evaluadores</h2></td>
              ...
              <tr>
                <td  align="center" colspan="3">
                        <asp:Panel ID="Panel1" runat="server" Height="500px" ScrollBars="Auto" 
                              Width="100%">
                              <asp:RadioButtonList ID="rbl_coordinEval" runat="server" Height="500px" 
                                  Width="100%">
                              </asp:RadioButtonList>
