...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="bodyContentPlace">
    ...
    <asp:Panel ID="pnlPrincipal" runat="server">
        ...
        <br />
        <br />
        <asp:GridView ID="gw_proyectos" runat="server" Width="98%" AutoGenerateColumns="False"
            DataKeyNames="IdProyecto" CssClass="Grilla" AllowPaging="True" DataSourceID="lds_proyectos"
            PageSize="20" AllowSorting="True" OnRowDataBound="gw_proyectos_RowDataBound"
                ...
                <asp:TemplateField HeaderStyle-Width="3%" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        ...
                        <asp:ImageButton ID="ibtn_Activar" runat="server" CommandArgument='<%# Bind("IdProyecto") %>'
                            CommandName="Activar" ImageUrl="~/Images/icoActivar.gif" Visible="false" OnClientClick="return alerta();"
                            OnClick="ibtn_Activar_Click" />
                    </ItemTemplate>
                </asp:TemplateField>
                <%--2--%>
                ...
                <asp:TemplateField HeaderText="Estado">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtn_inactivo" runat="server" CommandArgument='<%# Eval("IdProyecto") %>'
                            Text="Inactivo" CausesValidation="false" CommandName="ventanaInactivo" />
                    </ItemTemplate>
                </asp:TemplateField>
