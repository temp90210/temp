...
namespace Fonade.FONADE.evaluacion
{
    public partial class VerPerfilContacto : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                codcontacto = Session["codcontacto"] != null && !string.IsNullOrEmpty(Session["codcontacto"].ToString()) ? Session["codcontacto"].ToString() : "0";
            }
            ...
            try
            {
                ...
                if (RsContacto.Rows.Count > 0)
                {
                    ...
                    lbl_perfil.Text = lbl_perfil.Text + "                <TR vAlign=top><TD colSpan=2>&nbsp;</TD></TR>" +
                                                                    "					  <TR vAlign=top><TD colSpan=2 &nbsp;<strong>Información Académica</strong></TD></TR>";
                ...
                {
                    lbl_perfil.Text = lbl_perfil.Text + "                <TR vAlign=top><TD colSpan=2>&nbsp;</TD></TR>" +
                                                        "				<TR vAlign=top><TD colSpan=2><strong>Sectores a los que aplica</strong></TD></TR>";
                        ...
                        if (pasa)
                        {
                            switch (row["Orden"].ToString())
                            {
                                ...
                                case "2":
                                    ...
                                    break;
                                case "3":
                                    lbl_perfil.Text = lbl_perfil.Text + "				<TR vAlign=top><TD colspan='2'><strong>Otros Sectores</strong></TD></TR>";
                                    pasa = false;
                                    break;
                                default:
                                    break;
