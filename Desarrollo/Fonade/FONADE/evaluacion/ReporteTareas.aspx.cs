...
namespace Fonade.FONADE.evaluacion
{
    public partial class ReporteTareas1 : Negocio.Base_Page
    {
        ...
        private void CargarReporteTareas()
        {
            try
            {
                txtSQL = " select nomtareaprograma, nomproyecto, nomtareausuario, descripcion," +
                         ...
                         " and id_proyecto=codproyecto and id_tareausuario=codtareausuario and tu.codcontacto=" + usuario.IdContacto;

                var rsTarea = consultas.ObtenerDataTable(txtSQL, "text");
                Session["rsTarea"] = rsTarea;
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            var rt = Session["rsTarea"] as DataTable;
        ...
        /// Mauricio Arias Olave.
        /// 13/09/2014.
        /// RowDataBound para consultar ciertos aspectos del reporte de tareas.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            var dt = Session["rsTarea"] as DataTable;
