...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyContentPlace" runat="server">
    ...
    <asp:Panel ID="PanelModificar" runat="server" Visible="false">
        <table>
            ...
            <tr valign="top">
                <td>
                    <asp:DropDownList ID="ddlTipoVerificacion" runat="server" Width="251px" Height="16px" />
                </td>
            </tr>
            <tr valign="top">
                <td align="right">
    ...
    <asp:Panel ID="PnlActualizar" runat="server" Visible="false">
        ...
        <table>
            ...
            <tr valign="top">
                <td>
                    <asp:DropDownList ID="ddlTipoVerificacion1" runat="server" Width="251px" Height="16px" />
                </td>
            </tr>
            <tr valign="top">
                <td align="right">
                    <asp:Button ID="Btnupdate" runat="server" Text="Actualizar" OnClick="btn_update_Click" />
                    <asp:Button ID="Btndelete" runat="server" OnClick="btn_delete_Click" Text="Borrar"
