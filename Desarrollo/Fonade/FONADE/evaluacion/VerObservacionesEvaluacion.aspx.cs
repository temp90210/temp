        ...
        private void llenarOrden()
        {
            ...
            for(int i = 0; i < campo.Rows.Count; i++)
            {
                ...
                sql = @"SELECT C.[id_Campo], C.[Campo], P.[id_Campo] AS IDvARIABLE,
                    ...
                    FROM [Fonade].[dbo].[Campo] AS C
                    LEFT JOIN [Fonade].[dbo].[Campo] AS P ON C.[codCampo] = P.[id_Campo]
                    LEFT JOIN [Fonade].[dbo].[ConvocatoriaCampo] AS CC ON C.[id_Campo] = CC.[codCampo] AND
                    ...
                    LEFT JOIN [Fonade].[dbo].[EvaluacionCampo] EC ON C.[id_Campo] = EC.[codCampo] AND
        ...
        private void llenarjustificacion()
        {
            ...
            for (int i = 0; i < orden.Rows.Count; i++)
            {
                ...
                sql = @"SELECT [CodCampo],[Justificacion]
                        FROM [Fonade].[dbo].[EvaluacionCampoJustificacion]
