...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="bodyContentPlace">
    <asp:LinqDataSource ID="lds_listadoproy" runat="server" ContextTypeName="Datos.FonadeDBDataContext"
        AutoPage="false" OnSelecting="lds_listadoproy_Selecting">
    </asp:LinqDataSource>
    <asp:LinqDataSource ID="lds_CoordAignado" runat="server" ContextTypeName="Datos.FonadeDBDataContext"
        AutoPage="true" OnSelecting="lds_CoordAignado_Selecting">
    </asp:LinqDataSource>
