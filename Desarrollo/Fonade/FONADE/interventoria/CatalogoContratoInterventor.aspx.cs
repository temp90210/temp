...
namespace Fonade.FONADE.interventoria
{
    public partial class CatalogoContratoInterventor : Negocio.Base_Page
    {
        ...
        {
            Accion = Session["Accion_Interventor"] != null ? Accion = Session["Accion_Interventor"].ToString() : "";
            CodContacto_Seleccionado = Session["CodContacto_Seleccionado"] != null ? CodContacto_Seleccionado = Session["CodContacto_Seleccionado"].ToString() : "";
            NombreContactoSeleccionado = Session["NombreContactoSeleccionado"] != null ? NombreContactoSeleccionado = Session["NombreContactoSeleccionado"].ToString() : "";
        ...
        private void Crear(string opcional = null)
        {
            ...
            try
            {
                ...
                {
                    #region Inserción COMENTADA.
                    //sqlConsulta = " INSERT INTO InterventorContrato (CodContacto, NumContrato, FechaInicio, FechaExpiracion) " +
                    //              " VALUES (" + CodContacto_Seleccionado + "," + txt_NumContrato.Text + ",'" + fechaInicio + "','" + fechaFin + "')";
                    ...
                    ////Comprobar si sí se pudo hacer la inserción:
                    //if (ejecucion_correcta == true)
                    //{
        ...
        private void Actualizar()
        {
            ...
            //Verificar si la variable "CodContacto_Seleccionado" tiene datos.
            try { CodContacto_Seleccionado = Session["CodContacto_Seleccionado"].ToString(); }
            catch { return; }
            ...
            try
            {
                #region Actualización COMENTADA.
                ////Consulta de actualización:
                //sqlConsulta = " UPDATE InterventorContrato " +
                //              " SET FechaInicio = '" + fechaInicio + "' , " +
                //              " FechaExpiracion = '" + fechaFin + "', " +
                //              " Motivo = '" + txt_Motivo.Text.Trim() + "' " +
                //              " WHERE id_InterventorContrato = " + CodContrato_Seleccionado;
        ...
        private void Editar()
        {
            ...
            try
            {
                ...
                CodContacto_Seleccionado = Session["CodContacto_Seleccionado"].ToString();
            ...
            switch (e.CommandName)
            {
                case "VerNumero":
                    ...
                    if (lnkbtn != null)
                    {
                        ...
                        Session["p_cod_contacto"] = palabras[0];
                        Session["p_num_contrato"] = palabras[1];
                        Session["p_FechaInicio"] = palabras[2];
                        ...
                        //Cargar datos.
                        txt_NumContrato.Text = palabras[1];
