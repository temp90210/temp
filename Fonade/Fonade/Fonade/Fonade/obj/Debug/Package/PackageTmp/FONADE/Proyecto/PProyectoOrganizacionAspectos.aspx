<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PProyectoOrganizacionAspectos.aspx.cs"
    Inherits="Fonade.FONADE.Proyecto.PProyectoOrganizacionAspectos" %>
            ...
            <tr>
                <td style="width: 50%">
                    <div class="help_container">
                        <div onclick="textoAyuda({titulo: 'Constitución Empresa y Aspectos Legales', texto: 'AspectosLegales'});">
                ...
                <td>
                    <div id="div_Post_It_2" runat="server" visible="false">
                        <uc1:Post_It ID="Post_It2" runat="server" _txtCampo="AspectosLegales" _txtTab="1" />
                    </div>
                </td>
            </tr>
        </table>
        <asp:TextBox ID="txt_constitucion" class="editorHTML" runat="server" Width="100%"
            TextMode="MultiLine"></asp:TextBox>
        <div id="panel_constitucion" class="editorHTMLDisable" runat="server">
        </div>
        <ajaxToolkit:HtmlEditorExtender ID="txt_constitucion_HtmlEditorExtender" runat="server"
            TargetControlID="txt_constitucion" Enabled="True" EnableSanitization="false">
