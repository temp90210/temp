<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EvaluacionConclusion.aspx.cs"
    Inherits="Fonade.FONADE.evaluacion.EvaluacionConclusion" %>
            ...
            <tr>
                ...
                <td>
                    <div id="div_Post_It1" runat="server" visible="false">
                        <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="JustificacionEval" _txtTab="1" />
                    </div>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:TextBox ID="TB_Justificacion" runat="server" Height="100px" TextMode="MultiLine"
                        Width="99%" ValidationGroup="guardar" />
                    <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TB_Justificacion"
