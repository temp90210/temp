...
namespace Fonade.FONADE.PlandeNegocio
{
    ...
    public partial class CatalogoProyecto : Negocio.Base_Page
    {
        ...
        void void_ModificarDatos(int Grupocontacto)
        {
            if (Request.QueryString["CodProyecto"] != null)
            {
                ...
                var queryEeval = (from p in consultas.Db.Proyecto1s
                                  ...
                                  from ss in consultas.Db.SubSectors
                                  from s in consultas.Db.Sectors
        ...
        protected int int_CrearDatos(int codusuario)
        {
            ...
            if (String.IsNullOrEmpty(tb_Nombre.Text))
            {
                System.Windows.Forms.MessageBox.Show("El nombre es requerido", "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                return -1;
            }
            ...
            Proyecto1 Proyecto = new Proyecto1()
           {
            ...
            try
            {
                ...
                var maxidProyecto = (from p in consultas.Db.Proyectos
                                     select new
                                     {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var CiudadPrograma = (from c in consultas.Db.Ciudads
        ...
        protected void lds_Proyectos_Selecting(object sender, LinqDataSourceSelectEventArgs e)
        {
            ...
            var proyectos = from p in consultas.Db.Proyectos
                            from c in consultas.Db.Ciudads
        ...
        {
            int codproyecto = Int32.Parse(Request.QueryString["CodProyecto"]);
        ...
        protected void tb_crearPrograma_onclick(object sender, EventArgs e)
        {
            ...
            Emprendedor._fechaNaciE1 = DateTime.Parse(tb_fechanacimiento.Text);
        ...
        protected void btn_vistaprevia_perfil_onclick(object sender, EventArgs e)
        {

            CamposLectura_Escritura(tbl_Convenio, true);
            tc_Emprendedor.ActiveTab = tp_perfil;
        }

        //protected void btn_crearActualizarPrograma_onclick(object sender, EventArgs e) { 
        ...
        protected void btn_Inactivar_click(object sender, CommandEventArgs e)
        {
            ...
            if (conteo == 0)
            {
                ...
                var query3 = from pc in consultas.Db.ProyectoContactos
                             ...
                             select pc;
                var query4 = from c in consultas.Db.Contactos
        ...
        private void insertarContactoEstudio(objectEmcap Emprendedor, Int64 contactoid)
        {
            ...
            {
                txtAnioTitulo = Emprendedor._FechaGraduacionE.Split('-')[0];
            }
            else
            {
                txtAnioTitulo = "NULL";
            ...
            SqlDataReader reader = ejecutaReader(@"SELECT Id_ProgramaAcademico FROM ProgramaAcademico
                                                      ...
                                                      AND CodCiudad = (SELECT Id_Ciudad FROM Ciudad WHERE NomCiudad = '" + Emprendedor._ciudadIE + "')", 1);

            establecer(ref coProgramaAcademico, reader);

            reader = ejecutaReader("SELECT Id_Ciudad FROM Ciudad WHERE NomCiudad = '" + Emprendedor._ciudadIE + "'", 1);
            ...
            String txtSQL = @"INSERT INTO CONTACTOESTUDIO
                           ...
                           SEMESTRESCURSADOS,FlagIngresadoAsesor,FECHACREACION) VALUES (" + @"
                            ...
                            Emprendedor._nivelEstudioE + "','" + Emprendedor._estadoestudiosE + "','" + Emprendedor._fechainicioE + "','" + Emprendedor._fechafinalizacionMateriaE + "','" + Emprendedor._FechaGraduacionE + "',NULL,NULL,'1',GETDATE())";
        ...
        private void enviarPorEmail(String toTxt, String asuntoTxt, String mensajeTxt)
        {
            ...
            if (!(toTxt.Trim() == ""))
            {
                ...
                using (client)
                {
                    client.Credentials = new System.Net.NetworkCredential(usuario.Email, usuario.Password1);
        ...
        protected void Button3_Click1(object sender, EventArgs e)
        {
            ...
            //                    String ciudad = "";
            //                    //if (string.IsNullOrEmpty(Session["idInstitucionEvalRe"].ToString()))
            //                    //{
            ...
            if (reader != null)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("MD_CrearEmprendedor", con);
                        ...
                        cmd.Parameters.AddWithValue("@Identificacion", Int32.Parse(Emprendedor._noIdentificacion1));
                    ...
                    {
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Mensaje", "alert('Error: No se pudo ingresar el emprendedor.')", true);
                        return;
                    }
        ...
        protected void btnCrearPrograma_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(id_institucion))
            {
                ...
                if (reader.Read())
                {
                    txtSQL = "INSERT INTO INSTITUCIONEDUCATIVA VALUES(" + reader["VALOR"].ToString() + ",'" + NombrePrograma + "')";
                    ejecutaReader(txtSQL, 2);
            ...
            else
            {
                ...
                if (reader.Read())
                {
                    txtSQL = "INSERT INTO PROGRAMAACADEMICO VALUES(" + reader["VALOR"].ToString() + ",'" + NombrePrograma + "','N/A'," + id_institucion + ",'ACTIVO','N/A','','',1," + id_ciudadPrograma + ")";
                    ejecutaReader(txtSQL, 2);
        ...
        private void CargarInstituciones(string txtTipoConsulta, string txtletra)
        {
            ...
            try
            {
                ...
                Session["ProgramasAcademicos"] = rsConsulta;
            ...
            switch (e.CommandName)
            {
                ...
                case "seleccionar_3":
                    ...
                    try
                    {
                        ...
                        Session["CodProgramaAcademico"] = id_and_name[0];
            ...
            try
            {
                ...
                if (str == "")
                {
                    ...
                    if (savedData)
                    {
                        ...
                        Session["CodProgramaAcademico"] = CodProgramaAcademico;
        ...
        protected void lnkbtn_opcion_todos_Click(object sender, EventArgs e)
        {
            ...
            CargarInstituciones(Session["txtTipoConsulta"].ToString(), Session["upper_letter_selected"].ToString());
        }
        ...
        protected void btn_Buscar_Programa_Click(object sender, EventArgs e)
        {
            ...
            { CargarInstituciones(Session["txtTipoConsulta"].ToString(), txtBusqueda.Text.Trim()); }
            else
            {
        ...
        {
            var dt = Session["ProgramasAcademicos"] as DataTable;
        ...
        {
            Session["txtTipoConsulta"] = "programa";
        ...
        {
            Session["txtTipoConsulta"] = "institucion";
            tc_Emprendedor.ActiveTabIndex = 1;
            CargarCiudades_BusquedaInstituciones();
            ...
            switch (e.CommandName)
            {
                ...
                case "Borrar":
                    ...
                    try
                    {
                        ...
                        //Asignar valores a las variables.
                        CodContacto = parametros[0];
                        CodProyecto = parametros[1];
