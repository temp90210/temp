                ...
                <asp:TextBox ID="txtdinero" runat="server"  Width="156px"/>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ErrorMessage="Dinero" ForeColor="Red" ControlToValidate="txtdinero" 
                                Display="Dynamic" ValidationGroup="crear">*</asp:RequiredFieldValidator>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
                ...
                <asp:TextBox ID="txtespecie" runat="server" Width="158px" MaxLength="100"/>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ErrorMessage="Especie" ForeColor="Red" ControlToValidate="txtespecie" 
                    ...
                    TextMode="MultiLine"/>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ErrorMessage="Detalle" ForeColor="Red" 
                                ControlToValidate="txtDetalleespecie" ValidationGroup="crear">*</asp:RequiredFieldValidator>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
