<%@ Page Title="FONDO EMPRENDER" Language="C#" MasterPageFile="~/Emergente.Master" AutoEventWireup="true" CodeBehind="CatalogoInfraestructura.aspx.cs" Inherits="Fonade.FONADE.evaluacion.CatalogoInfraestructura" %>
   ...
   <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePageMethods="True">
    ...
    <table align="center" width="60%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtValorU" runat="server" Width="158px" />
                <ajaxToolkit:FilteredTextBoxExtender ID="TxtValorU_FilteredTextBoxExtender" runat="server"
                    Enabled="True" TargetControlID="TxtValorU" ValidChars="1234567890" FilterType="Numbers">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtCantidad" runat="server" Width="157px" />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtPorcentaje" runat="server" Width="157px" />
