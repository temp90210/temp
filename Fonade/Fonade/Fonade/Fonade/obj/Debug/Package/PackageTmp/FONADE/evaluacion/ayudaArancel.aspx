...
<body>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td align="center">
                <asp:RadioButtonList ID="RB_Buscar" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RB_Buscar_SelectedIndexChanged">
                    <asp:ListItem Value="1">Número Posición</asp:ListItem>
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Descripcion"  CssClass="Grilla">
                    <Columns>
