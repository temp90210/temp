<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoEvaluador.aspx.cs" Inherits="Fonade.FONADE.evaluacion.CatalogoEvaluador"  MasterPageFile="~/Master.Master"  %>
            ...
            <table width="100%">
              <tr>
                ...
                <td class="auto-style2">
                    <asp:ImageButton ID="ibtn_crearCoorE" runat="server" ImageAlign="AbsBottom" ImageUrl="~/Images/add.png" OnClick="ibtn_crearCoorE_Click" />
                    <asp:LinkButton ID="lbtn_crearEval" runat="server" OnClick="lbtn_crearEval_Click" >Crear un nuevo evaluador</asp:LinkButton>
                  </td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                ...
                <td class="auto-style2">
                    ...
                    <asp:GridView ID="gvcCoordinadoresEval"  CssClass="Grilla" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Planes de Negocio" SortExpression="Cuantos">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                     <asp:Button ID="hinhabilitado" Text='Habilitado' CommandArgument='<%#"" + Eval("id_contacto") + "," + Eval("Inhabilitado")%>' CommandName="verhabilitado" CssClass="boton_Link_Grid" runat="server"  />
                                </ItemTemplate>
                            </asp:TemplateField>
              ...
              <tr>
                ...
                <td class="auto-style4" align="center">
                    <asp:Button ID="btn_asignar" runat="server" CssClass="boton_Link" Text="Asignar Evaluador a Planes de Negocio" Width="235px" OnClick="btn_asignar_Click" />
                  </td>
