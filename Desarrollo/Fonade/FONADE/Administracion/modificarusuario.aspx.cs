    ...
    public partial class modificarusuario : Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    CodContactoSeleccionado = Session["CodContactoSeleccionado"] != null ? CodContactoSeleccionado = Convert.ToInt32(Session["CodContactoSeleccionado"].ToString()) : 0;
            ...
            try
            {
                if (CodContactoSeleccionado > 0)
                {
                    ...
                    if (dtEmpresas.Rows.Count > 0)
                    {
                        ...
                        if (valorEstado == 0) { ValorBloqueado = "1"; } else { ValorBloqueado = "0"; }
                        ...
                        if (ValorInactivo == "0") { valor1 = 0; } else { valor1 = 1; }
                        dd_EstaInactivo.Items[valor1].Selected = true;
                        ...
                        dd_EstaBloqueado.Items[valor2].Selected = true;

                        //Establecer si el CheckBox "de acuerdo a la consulta los carga "
                        /*b_flagAcreditador  */
                        chk_1.Checked = Convert.ToBoolean(dtEmpresas.Rows[0]["flagAcreditador"].ToString());
                        /*b_flagActaParcial  */
                        chk_2.Checked = Convert.ToBoolean(dtEmpresas.Rows[0]["flagActaParcial"].ToString());
                        /*b_flagGeneraReporte*/
                        chk_3.Checked = Convert.ToBoolean(dtEmpresas.Rows[0]["flagGeneraReporte"].ToString());

                        //Obtener Id_Clave.
                        ValorIdClave = Convert.ToInt32(dtEmpresas.Rows[0]["Id_Clave"].ToString());
                    }
                }
            }
            catch
        ...
        protected void btn_Modificar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                CodContactoSeleccionado = Convert.ToInt32(Session["CodContactoSeleccionado"].ToString());
                ...
                else
                {
                    ...
                    int v_2 = 0;
                    int v_3 = 0;
                    if (chk_1.Checked == true) { v_1 = 1; } else { v_1 = 0; }
                    if (chk_2.Checked == true) { v_2 = 1; } else { v_2 = 0; }
                    if (chk_3.Checked == true) { v_3 = 1; } else { v_3 = 0; }
