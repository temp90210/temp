            ...
            <tr>
                ...
                <td>
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 50%">
                                <span class="help_container"><span onclick="textoAyuda({titulo: 'Gastos de Personal', texto: 'GastosPersonal'});">
                                    <img src="../../Images/imgAyuda.gif" border="0" alt="help_Objetivos">
                                </span></span><b>Gastos de Personal:&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                            <td>
                                <div id="div_Post_It_3" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It3" runat="server" _txtCampo="GastosPersonal" _txtTab="1" />
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td align='left' valign='top' width='98%'>
                                ...
                                <asp:GridView ID="gw_GastosPersonal" runat="server" Width="100%" AutoGenerateColumns="False"
                                    ...
                                    OnRowDataBound="gw_GastosPersonal_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="width: 50%">
                                                        <span class="help_container"><span onclick="textoAyuda({titulo: 'Gastos de Puesta en Marcha', texto: 'GastosArranque'});">
                                                            <img src="../../Images/imgAyuda.gif" border="0" alt="help_Objetivos">
                                                        </span></span>Gastos de Puesta en Marcha:
                                                    </td>
                                                    <td>
                                                        <div id="div_Post_It_1" runat="server" visible="false">
                                                            <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="GastosArranque" _txtTab="1" />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <asp:GridView ID="gw_GastosPuestaMarca" runat="server" Width="100%" AutoGenerateColumns="False"
                                    CssClass="Grilla" OnRowCommand="gw_GastosPuestaMarca_RowCommand" DataKeyNames="protegido"
                                    ...
                                    <tr>
                                        <td align="left">
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="width: 50%">
                                                        <span class="help_container"><span onclick="textoAyuda({titulo: 'Gastos Anuales de Administracion', texto: 'GastosAnuales'});">
                                                            <img src="../../Images/imgAyuda.gif" border="0" alt="help_Objetivos" />
                                                        </span></span>Gastos Anuales de Administracion:
                                                    </td>
                                                    <td>
                                                        <div id="div_Post_It_2" runat="server" visible="false">
                                                            <uc1:Post_It ID="Post_It2" runat="server" _txtCampo="GastosAdmin" _txtTab="1" />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <asp:GridView ID="gw_GastosAnuales" runat="server" Width="100%" AutoGenerateColumns="False"
                                    CssClass="Grilla" OnRowCommand="gw_GastosAnuales_RowCommand" DataKeyNames="protegido"
