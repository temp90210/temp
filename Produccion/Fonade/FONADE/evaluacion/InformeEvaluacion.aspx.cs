    ...
    public partial class InformeEvaluacion : Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                CodConvocatoria = Session["CodConvocatoria"] != null ? CodConvocatoria = Session["CodConvocatoria"].ToString() : "0";
                Var_Accion = Session["Var_Accion"] != null ? Var_Accion = Session["Var_Accion"].ToString() : "";
        ...
        private DataTable ObservacionEvaluacion()
        {
            try
            {
                ...
                if (rs.Rows.Count > 0)
                {
                    ...
                    tabla_resultado.Columns.Add("Canales de distribución, estrategias de marcado", typeof(System.String));
        ...
        private void CargarEncabezado()
        {
            ...
            try
            {
                ...
                if (rs.Rows.Count > 0)
                {
                    ...
                    lbl_tr_emprendedores.Text = "<table width='100%' border='1' cellpadding='4' cellspacing='0' bordercolor='#000000'>" +
                                                "  <tr><td>" +
                    ...
                    if (rsAux.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < rsAux.Rows.Count; i++)
                        {
                            ...
                            lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "<tr>" +
                                                      "	 <td align='left'>" + rsAux.Rows[i]["Emprendedor"].ToString() + "</td>" +
                            ...
                            if (!String.IsNullOrEmpty(rsAux.Rows[i]["Beneficiario"].ToString()))
                            ...
                            Total1 = Total1 + (AporteDinero / 1000);
                            Total2 = Total2 + (AporteEspecie / 1000);
                    ...
                    try
                    {
                        ...
                        Suma_Total1_Total2_Formateado = Suma_Total1_Total2.ToString("0,0.00", CultureInfo.InvariantCulture);

                        //Formatear la variable "Total1".
                        Total1_Formateado = Total1.ToString("0,0.00", CultureInfo.InvariantCulture);

                        //Formatear la variable "Total2".
                        Total2_Formateado = Total2.ToString("0,0.00", CultureInfo.InvariantCulture);
                    ...
                    lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "  <tr><td>" +
        ...
        private void GenerarSegundaTabla()
        {
            try
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    ...
                    lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + " <table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>" +
                                                                            "     <tr><td colspan='7'>" +
        ...
        private void GenerarCuartaTabla()
        {
            ...
            try
            {
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "<table width='100%' border='0' cellpadding='3' cellspacing='1'>" +
                                                                            "<tr height='30' bgcolor='#000000'><td width='230' class='TituloTabla'><span style='color:#ffffff'>Indicadores Financieros proyectados</span></td>";
            ...
            try
            {
                ...
                foreach (DataRow row in rsAux.Rows)
                {
                    ...
                    if (row["Tipo"].ToString() == "#")
                    {
                        ...
                        Valor_Formateado = String.Format("{0:0.00}", Valor);
                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + Valor_Formateado;
                    }
                    #endregion
                }
            ...
            try
            {
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                            "<table width='100%' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>" +
                                "<tr><td>" +
                                    "<table width='100%' border='0' cellpadding='3' cellspacing='1'>			" +
                                        "<tr height='30' align='center' bgcolor='#000000'><td class='tituloTabla' colspan='4'><span style='color:#ffffff'>Resumen Concepto de Evaluaci&oacute;n</span></td></tr>" +
                                        "<tr bgcolor='#000000'>" +
                                        "	<td width='3%'  class='tituloTabla'>&nbsp;</td>" +
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                    "<tr bgcolor='<%=color(i mod 2)%>'><td width='3%' class='tituloTabla'>&nbsp;</td>" +
                            "<td align='right'  class='titulo'><span style='color:#ffffff'>Resultado General</span> </td>" +
                            "<td align='center' class='titulo'><span style='color:#ffffff'>" + numTotal + "</span></td>" +
                            "<td align='center' class='titulo'><span style='color:#ffffff'>" + numGranTotal + "</span></td>" +
                        "</tr>" +
                    "</table>" +
                "</tr>" +
            "</table>";
        ...
        private void GenerarDuodecimaTabla()
        {
            ...
            try
            {
                ...
                foreach (DataRow row_RS in RS.Rows)
                {
                    ...
                    lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                                    "<tr><td width='0%'></td>" +
                                                ...
                                                "<tr><td colspan='3'>" +
                                                    "<table width='100%' border='0' cellpadding='4' cellspacing='1'>			" +
                                                        "<tr bgcolor='#000000'>" +
                                                        "	<td class='tituloTabla' width='0%'>&nbsp;</td>" +
                                                        "	<td width='30%' class='tituloTabla'><span style='color:#ffffff'>Nombre</span></td>" +
                                                        "	<td width='25%' class='tituloTabla'><span style='color:#ffffff'>Detalle</span></td>						" +
                                                        "	<td width='15%' class='tituloTabla' align='center'><span style='color:#ffffff'>Total Solicitado</span></td>" +
                                                        "	<td width='5%' class='tituloTabla' align='center'><span style='color:#ffffff'>%</span></td>" +
                                                        "	<td width='18%' class='tituloTabla' align='center'><span style='color:#ffffff'>Total Recomendado</span></td>" +
                                                        "	<td width='5%' class='tituloTabla' align='center'><span style='color:#ffffff'>%</span></td>" +
                                                        "</tr>";
                    #endregion
                    ...
                    foreach (DataRow row_rsAux in rsAux.Rows)
                    {
                        ...
                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                            ...
                            "	<td align='right'>" + Double.Parse(row_rsAux["Solicitado"].ToString()).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +////
                            "	<td align='right'>";
                        ...
                        if (row_RS["TotalSolicitado"].ToString() != "0")
                        {
                            ...
                            lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                                (val_Solicitado * 100 / val_TotalSolicitado).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO"));
                        }
                        else { lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "0"; }
                        #endregion

                        #region Recomendado.
                        lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "	<td align='right'>" + Double.Parse(row_rsAux["Recomendado"].ToString()).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +//
                                            "	<td align='right'>";
                        ...
                        if (row_RS["TotalRecomendado"].ToString() != "0")
                        {
                            ...
                            lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                                (val_Recomendado * 100 / val_TotalRecomendado).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO"));
                        }
                        else { lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text + "0"; }
                        #endregion
                    ...
                    lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                        "<tr>" +
                            ...
                            "	<td align='right' class='Titulo'>" + Double.Parse(row_RS["TotalSolicitado"].ToString()).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +
                            "	<td align='right' class='Titulo'>100</td>" +
                            "	<td align='right' class='Titulo'>" + Double.Parse(row_RS["TotalRecomendado"].ToString()).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +
                            "	<td align='right' class='Titulo'>100</td>" +
                            "</tr>					" +
                        "</table>" +
                        "</td></tr>" +
                ...
                foreach (DataRow row_3_RS in RS.Rows)
                {
                    ...
                    lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                    "<td align='right'>" + ((d_AporteDinero + d_AporteEspecie) / 1000).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +
                    "<td align='right'>" + (d_AporteDinero / 1000).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +
                    "<td align='right'>" + (d_AporteEspecie / 1000).ToString("N2", System.Globalization.CultureInfo.CreateSpecificCulture("es-CO")) + "</td>" +
                ...
                lbl_tr_emprendedores.Text = lbl_tr_emprendedores.Text +
                    "<table border=0>" +
                    "	<tr><td colspan='2' class='Titulo'>Observaciones composición grupo de socios - Equipo de trabajo  </td></tr>" +
                    "	<tr><td colspan='2'>" +
