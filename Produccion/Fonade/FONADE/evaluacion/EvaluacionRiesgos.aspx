                    ...
                    <tr>
                        ...
                        <td>
                            <div id="div_Post_It1" runat="server" visible="false">
                                <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="RiesgoMitigacion" _txtTab="1" />
                            </div>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Grilla"
                    ...
                    AllowPaging="True" ForeColor="#666666" Width="100%" OnRowCommand="GridView1_RowCommand">
                    <Columns>
