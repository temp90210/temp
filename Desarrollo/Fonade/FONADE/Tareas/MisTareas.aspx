...
<asp:Panel ID="Panel1" runat="server"    Width="100%">  
        <div style="padding:20px 0px;">
            <asp:GridView ID="GridView1" CssClass="Grilla" OnPageIndexChanging="GridView1_PageIndexChanging"  runat="server"  AutoGenerateColumns="False" AllowPaging="true" AllowSorting="true" EnableTheming="True"> 
                <columns>                
