...
namespace Fonade.FONADE.evaluacion
{
    public partial class ProyectoAcreditacion : Base_Page
    {
        ...
        {
            if (Session["CodProyecto"] != null && Session["CodConvocatoria"] != null)
            {
                Codproyecto = (int) Session["CodProyecto"];
                CodConvocatoria = (int) Session["CodConvocatoria"];
            }
            else
            {
        ...
        {
            var estado = consultas.Db.Proyectos.FirstOrDefault(p => p.Id_Proyecto == Codproyecto);
        ...
        void ObtenerInformacionGeneral()
        {
            try
            {
                ...
                if (dtsInformacion.Tables.Count!=0)
                {
                    ...
                    {
                        Session["dtcrif"] = dtsInformacion.Tables[7];
                    }
                    else
                    {
                        Session["dtcrif"] = null;
        ...
        string ObtenerNombreconvocatoria()
        {
            ...
            var convocatoria = consultas.Db.Convocatorias.FirstOrDefault(c => c.Id_Convocatoria == CodConvocatoria);
        ...
        string ObtenerNombreProyecto()
        {
            ...
            var proyecto = consultas.Db.Proyectos.FirstOrDefault(c => c.Id_Proyecto == Codproyecto);
            ...
            try
            {
                ...
                if (Codproyecto != 0 && CodConvocatoria != 0)
                {
                    ...
                    if (dtResultConvocatorias.Rows.Count!=0)
                    {
                        ...
                        Session["dtResultConvocatoria"] = dtResultConvocatorias;
        ...
        {
           Session["codpNotificacion"] = Codproyecto;
           Session["codcNotificacion"] = CodConvocatoria;
