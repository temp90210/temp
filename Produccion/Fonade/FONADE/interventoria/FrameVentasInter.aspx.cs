...
namespace Fonade.FONADE.interventoria
{
    public partial class FrameVentasInter : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string interno_CodVentas = Session["interno_CodVentas"] != null && !string.IsNullOrEmpty(Session["interno_CodVentas"].ToString()) ? Session["interno_CodVentas"].ToString() : "0";
        ...
        private void CargarDetalle(string parametros)
        {
            ...
            if (!string.IsNullOrEmpty(variables.ToString()))
            {
                ...
                try
                {
                    ...
                    Session["interno_CodVentas"] = variables[0].ToString();
        ...
        public void DynamicCommand_VerAvance(Object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                Session["CodProduccion"] = valores_command[2].ToString();
                //Ya se le está enviado la nómina seleccionada en una variable de sesión.
                Session["MesDelProducto_Venta_Seleccionado"] = valores_command[3].ToString();
                                    ...
                                    if (usuario.CodGrupo == Constantes.CONST_Emprendedor)
                                    {
                                        ...
                                        else
                                        {
                                            if (String.IsNullOrEmpty(rsTipo2.Rows[0]["ObservacionesInterventor"].ToString()))
                                            {
                                                ...
                                                img_VerAvance_Elim.ImageUrl = "~/Images/icoAdicionarUsuario.gif";
                ...
                if (e.Row.RowIndex == -1)
                {
                    ...
                    if (usuario.CodGrupo == Constantes.CONST_Interventor)
                    {
                        ...
                        for (int i = 1; i <= 14; i++)
                        {
                            ...
                            {
                                string txtSQL = "SELECT * FROM AvanceVentasPOMes WHERE CodProducto=" + Convert.ToInt32(Session["CodProduccion"].ToString()) + " AND mes=" + i + "";
        ...
        protected void gv_Detallesproductos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "editar")
            {
                ...
                Session["MesDelProducto_Venta_Seleccionado"] = e.CommandArgument;
