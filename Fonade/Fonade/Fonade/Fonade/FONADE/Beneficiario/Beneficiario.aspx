                ...
                <table width="98%" border="0">
                    ...
                    <tr>
                        ...
                        <td class="style17" valign="baseline">
                            <asp:DropDownList ID="ddl_tipoid" runat="server" Height="19px" Width="215px" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style16" valign="baseline">
                            ...
                            <br />
                            <small style="color: #CC0000;">(Por favor ingrese sin digito de verificación!!!)</small>
                        </td>
                        <td class="style17" valign="baseline">
                            <asp:TextBox ID="txt_numdocumento" runat="server" Width="198px" MaxLength="14" />
                        </td>
                        <td>
