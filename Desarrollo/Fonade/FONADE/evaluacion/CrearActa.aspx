    ...
    <asp:Panel ID="PanelAgregar" runat="server">
        <table align="left" width="70%">
            <tr>
                ...
                <td align="left" colspan="4">
                    <asp:ValidationSummary ID="ValidationSummary1" runat="server" BackColor="White" Font-Bold="True"
                        Font-Italic="False" ForeColor="Red" HeaderText="Llene los Siguientes Campos"
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="DdlCodConvocatoria" runat="server" BackColor="White" DataSourceID="lds_convocatoria"
                        DataTextField="Nombre" DataValueField="Id" Width="503px">
                    </asp:DropDownList>
                    <asp:LinqDataSource ID="lds_convocatoria" runat="server" ContextTypeName="Datos.FonadeDBDataContext"
                        OnSelecting="lds_convocatoria_Selecting">
                    </asp:LinqDataSource>
                </td>
                <td class="style10">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="DdlCodConvocatoria"
                        Display="Dynamic" ErrorMessage="Convocatoria" ForeColor="Red" InitialValue="0"
                        ValidationGroup="crear">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4">
                    ...
                    <asp:Panel ID="panelNegocioGrid" runat="server">
                        <asp:GridView ID="GrvPlanesNegocio" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            OnRowCommand="GrvPlanesNegocio_RowCommand" AllowPaging="True" DataSourceID="lds_planesnegocio"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=btnimprimir.ClientID%>").click(function (event) {
                ...
                $.fn.windowopen('../evaluacion/ImprimirActa.aspx?CodActa=' + id, 670, 530, 'no', 1, 'no');
            });
