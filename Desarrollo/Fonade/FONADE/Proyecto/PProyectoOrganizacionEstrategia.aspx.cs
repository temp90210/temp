...
namespace Fonade.FONADE.Proyecto
{
    public partial class PProyectoOrganizacionEstrategia : Negocio.Base_Page
    {
        ...
        private void definirCampos()
        {
            if (poe != null)
            {
                procesarCampo(ref txt_analisis, ref txt_analisis_HtmlEditorExtender, ref panel_analisis, poe.AnalisisDOFA, miembro, realizado, codConvocatoria);
                procesarCampo(ref txt_organismos, ref txt_organismos_HtmlEditorExtender, ref panel_organismos, poe.OrganismosApoyo, miembro, realizado, codConvocatoria);
            }
            else
            {
