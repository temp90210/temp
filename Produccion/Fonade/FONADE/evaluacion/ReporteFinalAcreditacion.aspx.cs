...
namespace Fonade.FONADE.evaluacion
{
    public partial class ReporteFinalAcreditacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (String.IsNullOrEmpty(Session["EvalidConvocatoria"].ToString()))
                {
                    Response.Redirect("ActasReporteFinalAcreditacion.aspx");
                }
                else
                {
                    idCOnvocatoria = Session["EvalidConvocatoria"].ToString();
                }
            }
            catch (Exception)
            {
            ...
            if (!IsPostBack)
            {
                ...
                //CrearEvento();
                Session["P_TablaEval"] = tablaExpor._Tabla;
            }
        ...
        protected void LB_Desacargar_Click(object sender, CommandEventArgs e)
        {
            ...
            Session["commadArgumentAnexoEmprendedor"] = commadArgument;
