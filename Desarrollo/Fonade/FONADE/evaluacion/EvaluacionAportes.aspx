                        ...
                        <tr>
                            ...
                            <td>
                                <div id="div_Post_It1" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="Aportes" _txtTab="1" />
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <td>
                    <asp:Panel ID="pnlagregar" runat="server">
                        ...
                        <img id="Adicionar" runat="server" src="../../Images/icoAdicionarUsuario.gif" style="cursor: pointer;"
                            alt="Adicionar" />
                        <a id="Hadicionar" style="cursor: pointer;" href="" runat="server">Adicionar</a>
                    </asp:Panel>
                </td>
            </tr>
        </table>
                ...
                <table style="margin: 0px auto; float: right;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center; width: 25%;">
                                <asp:Label ID="ldif1A" runat="server" BorderStyle="None" Font-Bold="True" />
                                <td style="text-align: center; width: 25%;">
                ...
                <table style="margin: 0px auto; float: right;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center; width: 25%;">
                                <asp:Label ID="ldif1c" runat="server" BorderStyle="None" Font-Bold="True" />
                                <td style="text-align: center; width: 25%;">
