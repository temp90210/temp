...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="bodyContentPlace">
    <asp:Panel ID="pnlprincipal" runat="server">
        ...
        <table>
            <tr>
                <td>Fiduciaria :</td>
                <td><asp:DropDownList ID="ddlcontacto" runat="server" DataTextField="Email" DataValueField="Id_Contacto" CssClass="ddlcon" DataSourceID="odscontacto"></asp:DropDownList>
