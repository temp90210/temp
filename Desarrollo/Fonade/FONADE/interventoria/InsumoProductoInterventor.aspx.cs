    ...
    public partial class InsumoProductoInterventor : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                s_CodProducto = Session["s_CodProduccion"] != null && !string.IsNullOrEmpty(Session["s_CodProduccion"].ToString()) ? Session["s_CodProduccion"].ToString() : "0";
                s_NombreProducto = Session["s_NombreProducto"] != null && !string.IsNullOrEmpty(Session["s_NombreProducto"].ToString()) ? Session["s_NombreProducto"].ToString() : "0";
                s_CodProyecto = Session["s_CodProyecto"] != null && !string.IsNullOrEmpty(Session["s_CodProyecto"].ToString()) ? Session["s_CodProyecto"].ToString() : "0";
