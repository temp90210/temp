    ...
    public partial class PlanesDeNegocio : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    if (String.IsNullOrEmpty(Session["idCodigoProUser"].ToString()))
                    ...
                    else
                    {
                        ...
                        txtSQL = " SELECT ID_CONTACTO, (NOMBRES + ' ' + APELLIDOS) 'NOMBRE' FROM CONTACTO WHERE Id_Contacto = " + Session["idCodigoProUser"].ToString();
        ...
        private void CargarTabla()
        {
            try
            {
                txtSQL = " SELECT DISTINCT P.ID_PROYECTO 'CODIGO', P.NOMPROYECTO 'NOMBRE' " +
                         ...
                         " ON (PC.CODCONTACTO = " + Session["idCodigoProUser"].ToString() + " AND PC.INACTIVO=0 " +
                         " AND PC.ACREDITADOR = 1 AND PC.CODPROYECTO= P.ID_PROYECTO AND P.INACTIVO =0) " +
                         " ORDER BY 'NOMBRE' ASC ";

                var dt = consultas.ObtenerDataTable(txtSQL, "text");

                Session["dt_Empresas_2"] = dt;
        ...
        {
            var dt = Session["dt_Empresas_2"] as DataTable;
        ...
        protected void GridView1_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (dt != null)
            {
                ...
                GridView1.DataSource = Session["dt_Empresas_2"];
                GridView1.DataBind();
            }
        }
    }
