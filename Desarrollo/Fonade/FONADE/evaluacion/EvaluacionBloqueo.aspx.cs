...
{
    public partial class EvaluacionBloqueo : System.Web.UI.Page
    {
        ...
        protected void LB_Editar_Nombre_Click(object sender, EventArgs e)
        {
            ...
            Session["EvalCodProyecto"] = idNomParametro;
        ...
        public DataTable contacto()
        {
            ...
            String sql = "SELECT id_Proyecto, nomProyecto FROM Proyecto WHERE CodEstado = " + Constantes.CONST_Evaluacion;
