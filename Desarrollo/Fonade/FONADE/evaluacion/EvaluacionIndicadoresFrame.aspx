    ...
    <form id="form1" runat="server">
      <div>
        ...
        <ajaxToolkit:TabContainer ID="tc_proyectos" runat="server" ActiveTabIndex="0" 
            ...
            <ajaxToolkit:TabPanel ID="tc_plan" OnDemandMode="Once" runat="server" Width="100%" Height="100%">
                <HeaderTemplate>
                    <div class="tab_header" id="aportes" onclick="CargarPestana('frmaportes','EvaluacionAportes.aspx')">
                        <span>Aportes</span>
                    </div>
                </HeaderTemplate>
                <ContentTemplate>
                    <iframe id="frmaportes" src="" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto" width="100%" height="100%"></iframe>
                </ContentTemplate>
            </ajaxToolkit:TabPanel>
            <ajaxToolkit:TabPanel ID="tc_nomina" runat="server" Width="100%" Height="100%">
                <HeaderTemplate>
                    <div class="tab_header" onclick="CargarPestana('frmNomina','EvaluacionProductos.aspx')">
            ...
            <ajaxToolkit:TabPanel ID="tc_produccion" runat="server" Width="100%" Height="100%">
                <HeaderTemplate>
                    <div class="tab_header" onclick="CargarPestana('frmproduccion','EvaluacionRiesgos.aspx')">
                      <span>Riesgos</span>
                    </div>
                </HeaderTemplate>
                <ContentTemplate>
            ...
            <ajaxToolkit:TabPanel ID="tc_ventas" runat="server" Width="100%" Height="100%">
                <HeaderTemplate>
                    <div class="tab_header" onclick="CargarPestana('frmventas','EvaluacionConclusion.aspx')">
