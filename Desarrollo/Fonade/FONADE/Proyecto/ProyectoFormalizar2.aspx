    ...
    <table width='98%'  bgcolor="#00468F" style="color: #FFFFFF">
            ...
            Height="30px" Width="98%">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Beneficiario Fonade">
                        <ItemTemplate>
                            <asp:CheckBox ID="checkbeneficiario" runat="server" Checked='<%# Eval("beneficiarioQ4")%>' Enabled="false"></asp:CheckBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Participación Accionaria">
                        <ItemTemplate >
                            <asp:Label ID="Tx_partaccion" runat="server" Text='<%# Eval("participacionQ4") + " %"%>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <!--------------------------------->
         <table class="style1">
          ...
          <tr>
            <td align="left" class="style3">
                <asp:TextBox ID="Txt_Aval" runat="server" Text="" MaxLength="500" TextMode="MultiLine" Width="400px"></asp:TextBox>
          ...
          <tr>
            <td align="left" class="style10"  width="21%">Convocatoria:   
                 <asp:DropDownList ID="DropDownListConvoct" runat="server" >
                 </asp:DropDownList>
        ...
        <table class="style9" >
          ...
          <tr>
            <td align="center">
                <asp:Button ID="BotónFormalizar" runat="server" Text="Guardar"  onclick="ButtonGuardar_Click" />
            </td>
          </tr>
         </table>
        <br />
