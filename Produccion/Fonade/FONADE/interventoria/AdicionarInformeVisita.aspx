<%@ Page Language="C#" MasterPageFile="~/Master.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="AdicionarInformeVisita.aspx.cs" Inherits="Fonade.FONADE.interventoria.AdicionarInformeVisita" %>
            ...
            <table class="auto-style2">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <asp:TextBox ID="medio1" runat="server" Width="150px" Text="0"></asp:TextBox>
                    </td>
                    <td colspan="2">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <asp:TextBox ID="medio2" runat="server" Width="150px" Text="0"></asp:TextBox>
                    </td>
                    <td colspan="2">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <asp:TextBox ID="medio3" runat="server" Width="150px" Text="0"></asp:TextBox>
                    </td>
                    <td colspan="2">
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <asp:TextBox ID="medio4" runat="server" Width="150px" Text="0"></asp:TextBox>
                    </td>
                    <td colspan="2">
                        &nbsp;
                    </td>
                ...
                <tr>
                    <td colspan="4">
                        <asp:TextBox ID="tb_info_tecnica" runat="server" Width="500px" TextMode="MultiLine"
                            Height="150px" MaxLength="8000"></asp:TextBox>
                        <br />
                ...
                <tr>
                    <td colspan="4" class="auto-style3">
                        <asp:TextBox ID="tb_info_financiera" runat="server" Width="500px" TextMode="MultiLine"
                            Height="150px" MaxLength="8000"></asp:TextBox>
                        <br />
