...
namespace Fonade.FONADE.Proyecto
{
    public partial class PProyectoOperacion : Negocio.Base_Page
    {
        ...
        private void definirCampos()
        {
            ...
            if (po != null)
            {
                procesarCampo(ref txt_fichaProducto, ref txt_fichaProducto_HtmlEditorExtender, ref panel_fichaProducto, po.FichaProducto, true, false, "");
                procesarCampo(ref txt_estadoDesarrollo, ref txt_estadoDesarrollo_HtmlEditorExtender, ref panel_estadoDesarrollo, po.EstadoDesarrollo, true, false, "");
                procesarCampo(ref txt_descripcionProceso, ref txt_descripcionProceso_HtmlEditorExtender, ref panel_descripcionProceso, po.DescripcionProceso, true, false, "");
                procesarCampo(ref txt_necesidades, ref txt_necesidades_HtmlEditorExtender, ref panel_necesidades, po.Necesidades, true, false, "");
                procesarCampo(ref txt_planProduccion, ref txt_planProduccion_HtmlEditorExtender, ref panel_planProduccion, po.PlanProduccion, true, false, "");
            }
        ...
        protected void btm_guardarCambios_Click(object sender, EventArgs e)
        {
            ...
            if (query.Count() > 0)
            {
                ProyectoOperacion pmv = new ProyectoOperacion()
                {
                    ...
                    FichaProducto = txt_fichaProducto.Text,
                    EstadoDesarrollo = txt_estadoDesarrollo.Text,
                    DescripcionProceso = txt_estadoDesarrollo.Text,
                    Necesidades = txt_necesidades.Text,
                    PlanProduccion = txt_planProduccion.Text
                };
            ...
            {
                po.FichaProducto = txt_fichaProducto.Text;
                po.EstadoDesarrollo = txt_estadoDesarrollo.Text;
                po.DescripcionProceso = txt_estadoDesarrollo.Text;
                po.Necesidades = txt_necesidades.Text;
                po.PlanProduccion = txt_planProduccion.Text;
            }
