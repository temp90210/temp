...
namespace Fonade.FONADE.evaluacion
{
    public partial class DownloadScript : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //string plantillaModeloPrueba = WebConfigurationManager.AppSettings["PlantillaModeloFinancieroPrueba"].ToString();
            //string rutafinal = "";


            //if (File.Exists(plantillaModeloPrueba))
            //{
            //    rutafinal = plantillaModeloPrueba;
            //}
            //else
            //{
            //    rutafinal = plantillaModelo;
            //}
