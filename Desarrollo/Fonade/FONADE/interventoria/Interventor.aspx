        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelCrear" runat="server" Visible="false">
                ...
                <table id="tb_cr_int" runat="server" width="95%" border="0" align="center" cellspacing="1"
                    ...
                    <tr>
                        <td>
                            <asp:ListBox ID="LB_Sectores" runat="server" Height="150px" SelectionMode="Multiple"
                ...
                <table width="95%" border="0" align="center" cellspacing="1" cellpadding="3">
                    <tbody>
                        ...
                        <tr id="tr_Cargo" runat="server">
                            <td colspan="1">
                                <asp:Label ID="Label2" runat="server" Text="Cargo:" Font-Bold="true" />
                            </td>
                            <td colspan="3">
                                <asp:Label ID="L_Cargo" runat="server" Text="" />
                            </td>
                            <td>
                                &nbsp;
                            </td>
