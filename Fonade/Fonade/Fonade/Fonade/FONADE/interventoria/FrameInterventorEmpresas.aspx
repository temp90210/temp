        ...
        <table border="0" cellpadding="0" cellspacing="5">
            <tr>
                ...
                <td valign="top">
                    ...
                    <p>
                        <span>Sector:</span></p>
                    <asp:DropDownList ID="dd_Sectores" runat="server" AutoPostBack="true" Width="354px"
                    ...
                    <asp:GridView ID="gv_sectores_encontrados" runat="server" AutoGenerateColumns="false"
                        GridLines="None" OnRowDataBound="gv_sectores_encontrados_RowDataBound" OnRowCommand="gv_sectores_encontrados_RowCommand"
                        CssClass="Grilla">
                        <EmptyDataTemplate>
                            No hay Empresas en ninguna convocatoria para el sector seleccionado</EmptyDataTemplate>
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HiddenField ID="hdf_nmb" runat="server" Visible="false" Value='<%# Eval("RazonSocial") %>' />
                                    ...
                                    <asp:LinkButton ID="lnk_btn_sector_seleccionar" Text="" runat="server" CausesValidation="false"
