<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PProyectoResumen.aspx.cs"
    Inherits="Fonade.FONADE.Proyecto.PProyectoResumen" %>
        ...
        <ContentTemplate>
            ...
            <table width="100%" border="0" bgcolor="White">
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td id="td_Post_It1" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="ConceptoNegocio" _txtTab="1" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="tr_concepto_vi" runat="server" visible="false">
                    <td>
                        <div id="div_concepto" runat="server" visible="false" style="width: 840px; height: 200px;
                            border-color: Black; border-style: solid; border-width: 2px; overflow: scroll;
                            overflow-x: hidden !important; padding: 15px;">
                        </div>
                    </td>
                </tr>
                <%-- ------------------------------------------------------------------------------------------------- --%>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td id="td_Post_It2" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It2" runat="server" _txtCampo="PotencialMercados" _txtTab="1" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="tr_potencial_vi" runat="server" visible="false">
                    <td>
                        <div id="div_potencial" runat="server" visible="false" style="width: 840px; height: 200px;
                            border-color: Black; border-style: solid; border-width: 2px; overflow: scroll;
                            overflow-x: hidden !important; padding: 15px;">
                        </div>
                    </td>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td id="td_Post_It3" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It3" runat="server" _txtCampo="VentajasCompetitivas" _txtTab="1" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="tr_ventajas_vi" runat="server" visible="false">
                    <td>
                        <div id="div_ventajas" runat="server" visible="false" style="width: 840px; height: 200px;
                            border-color: Black; border-style: solid; border-width: 2px; overflow: scroll;
                            overflow-x: hidden !important; padding: 15px;">
                        </div>
                    </td>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td id="td_Post_It4" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It4" runat="server" _txtCampo="ResumenInversiones" _txtTab="1" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="tr_resumen_vi" runat="server" visible="false">
                    <td>
                        <div id="div_resumen" runat="server" visible="false" style="width: 840px; height: 200px;
                            border-color: Black; border-style: solid; border-width: 2px; overflow: scroll;
                            overflow-x: hidden !important; padding: 15px;">
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td id="td_Post_It5" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It5" runat="server" _txtCampo="Proyecciones" _txtTab="1" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="tr_proyecciones_vi" runat="server" visible="false">
                    <td>
                        <div id="div_proyecciones" runat="server" visible="false" style="width: 840px; height: 200px;
                            border-color: Black; border-style: solid; border-width: 2px; overflow: scroll;
                            padding: 15px;">
                        </div>
                    </td>
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td id="td_Post_It6" runat="server" visible="false">
                                    <uc1:Post_It ID="Post_It6" runat="server" _txtCampo="ConclusionesFinancieras" _txtTab="1" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr id="tr_conclusiones_vi" runat="server" visible="false">
                    <td>
                        <div id="div_conclusiones" runat="server" visible="false" style="width: 840px; height: 200px;
                            border-color: Black; border-style: solid; border-width: 2px; overflow: scroll;
                            overflow-x: hidden !important; padding: 15px;">
                        </div>
                    </td>
