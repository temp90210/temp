    ...
    public partial class FirmaCoordinador : Negocio.Base_Page //System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Datos = Session["Datos"] != null && !string.IsNullOrEmpty(Session["Datos"].ToString()) ? Session["Datos"].ToString() : "";
                Firma = Session["Firma"] != null && !string.IsNullOrEmpty(Session["Firma"].ToString()) ? Session["Firma"].ToString() : "";
                numSolicitudes = Session["numSolicitudes"] != null && !string.IsNullOrEmpty(Session["numSolicitudes"].ToString()) ? Session["numSolicitudes"].ToString() : "0";
