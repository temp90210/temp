...
<body style="overflow-x: hidden;">
    ...
    <asp:LinqDataSource ID="lds_socios" runat="server" ContextTypeName="Datos.FonadeDBDataContext"
        OnSelecting="lds_socios_Selecting">
    </asp:LinqDataSource>
    ...
    <div class="contenedor">
        ...
        <div class="contenedor" style="overflow-x: visible; overflow-y: hidden; width: 100% !important;
            ...
            <asp:GridView ID="gvsocios" runat="server" AutoGenerateColumns="false" CssClass="Grilla"
                DataKeyNames="CodContacto" DataSourceID="lds_socios" HeaderStyle-HorizontalAlign="Center">
                <Columns>
                    <asp:BoundField HeaderText="Nombre del Emprendedor" DataField="Nombre" />
                    ...
                    <asp:TemplateField HeaderText="Representante Legal" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:RadioButton ID="rb_representante" runat="server" Enabled='<%# Eval("activo") %>'
                                Checked='<%# Eval("RepresentanteLegal") %>' GroupName="Representante" ValidationGroup="guardar" />
                    ...
                    <asp:TemplateField HeaderText="Suplente" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:RadioButton ID="rb_suplente" runat="server" Enabled='<%# Eval("activo") %>'
                                Checked='<%# Eval("Suplente") %>' GroupName="Suplente" ValidationGroup="guardar" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Dirección">
                        <ItemTemplate>
                            <asp:TextBox ID="txtdireccion" runat="server" Enabled='<%# Eval("activo") %>' Text='<%# Eval("Direccion") %>'
                    ...
                    <asp:TemplateField HeaderText="Participación Accionaria">
                        <ItemTemplate>
                            <asp:TextBox ID="txtParticipacion" runat="server" Enabled='<%# Eval("activo") %>'
                                Text='<%# Eval("participacion") %>' MaxLength="15" ValidationGroup="guardar"
                                Width="94" />
                            <br />
                    ...
                    <asp:TemplateField HeaderText="Ciudad">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlciudad" runat="server" Enabled='<%# Eval("activo") %>' DataTextField="NomCiudad"
            ...
            <td>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddltiposociedad" runat="server" DataValueField="Id_TipoSociedad"
                                DataTextField="NomTipoSociedad" DataSourceID="lds_tiposociedad" Width="400px"
                                ValidationGroup="guardar">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txttelefono" runat="server" Width="400px" ValidationGroup="guardar" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblnitverificacion" runat="server" Text="Omita dígito de verificación, guiones y puntos"
                                ForeColor="#ff0000" />
                            <br />
                            <asp:TextBox ID="txtnit" runat="server" Width="400px" ValidationGroup="guardar" />
                        </td>
                    </tr>
                    <tr>
                        <td>
