...
<body onload="imprimir()">
    <div id="contentPrincipal">
        ...
        <table border="0" cellspacing="0" cellpadding="2" width="100%" onmousemove="clk();">
            <tbody>
                <tr>
                    <td width="175" align="center" valign="baseline" bgcolor="#000000" class="Blanca">
        ...
        <%--Tabla dibujada.--%>
        <asp:Label ID="lbl_tr_emprendedores" Text="" runat="server" />
    </div>
</body>
</html>
