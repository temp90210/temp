...
<body>
    ...
    <div style="width: 99%">
        ...
        <asp:TextBox ID="Actividades" runat="server" CssClass="actividades validarLargo"
    ...
    <div style="width: 99%">
        ...
        <%--<textarea runat="server" id="ProductosServicios" style="width: 100%; height: 112px;"
            rows="6" class="boxes" name="ProductosServicios"></textarea>--%>
        <asp:TextBox ID="ProductosServicios" runat="server" CssClass="actividades validarLargo"
            TextMode="MultiLine" Height="146px" Width="100%" />
    </div>
    <br />
    <div style="width: 99%">
        ...
        <%--<textarea style="width: 100%; height: 112px;" id="EstrategiaMercado" runat="server"
            rows="6" class="boxes" name="EstrategiaMercado"></textarea>--%>
        <asp:TextBox ID="EstrategiaMercado" runat="server" CssClass="actividades validarLargo"
            TextMode="MultiLine" Height="146px" Width="100%" />
    </div>
    <br />
    <div style="width: 99%">
        ...
        <%--<textarea id="ProcesoProduccion" runat="server" style="width: 100%; height: 112px;"
            rows="6" name="ProcesoProduccion"></textarea>--%>
        <asp:TextBox ID="ProcesoProduccion" runat="server" CssClass="actividades validarLargo"
            TextMode="MultiLine" Height="146px" Width="100%" />
    </div>
    <br />
    <div style="width: 99%">
        ...
        <%--<textarea style="width: 100%; height: 112px;" id="EstructuraOrganizacionalEval" rows="6"
            runat="server" name="EstructuraOrganizacionalEval"></textarea>--%>
        <asp:TextBox ID="EstructuraOrganizacionalEval" runat="server" CssClass="actividades validarLargo"
            TextMode="MultiLine" Height="146px" Width="100%" />
    </div>
    <br />
    <div style="width: 99%">
        ...
        <%--<textarea style="width: 100%; height: 112px;" rows="6" id="TamanioLocalizacion" runat="server"
            name="TamanioLocalizacion"></textarea>--%>
        <asp:TextBox ID="TamanioLocalizacion" runat="server" CssClass="actividades validarLargo"
            TextMode="MultiLine" Height="146px" Width="100%" />
    </div>
    <br />
    <div style="width: 99%">
        ...
        <%--<textarea style="width: 100%; height: 112px;" rows="6" id="Generales" runat="server"
            name="Generales"></textarea>--%>
        <asp:TextBox ID="Generales" runat="server" CssClass="actividades validarLargo" TextMode="MultiLine"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=btnGuardar.ClientID %>").click(function () {
                ...
                entidad.Actividades = $(".actividades").val();
                entidad.ProductosServicios = $("#ProductosServicios").val();
                entidad.EstrategiaMercado = $("#EstrategiaMercado").val();
                entidad.ProcesoProduccion = $("#ProcesoProduccion").val();
                entidad.EstructuraOrganizacional = $("#EstructuraOrganizacionalEval").val();
                entidad.TamanioLocalizacion = $("#TamanioLocalizacion").val();
                entidad.Generales = $("#Generales").val();
        ...
        function Guardar(entidad) {
            ...
            $.ajax({
                ...
                url: "EvaluacionObservaciones.aspx/Guardar",
