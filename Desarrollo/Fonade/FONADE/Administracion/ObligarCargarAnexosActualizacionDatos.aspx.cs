...
{
    public partial class ObligarCargarAnexosActualizacionDatos : Base_Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Title = "FONDO EMPRENDER - OBLIGAR CARGAR ANEXOS";
        ...
        protected void btn_Actualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dtEmpresas.Rows.Count == 0)
                {
                    ...
                    sqlConsulta = " INSERT INTO parametro (nomparametro, valor) " +
                                              " VALUES('ObligatoriedadCagarAnexosActualizacionDatos','" + valor_chequeado + "')";
                ...
                else
                {
                    ...
                    sqlConsulta = " UPDATE parametro SET valor = '" + valor_chequeado + "' " +
                                              " WHERE nomparametro = 'ObligatoriedadCagarAnexosActualizacionDatos' ";
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Mensaje", "alert('Error en consulta principal (2).')", true);
                return;
            }
        }
