        ...
        <div>
            ...
            <ajaxToolkit:TabContainer ID="tc_proyectos" runat="server" ActiveTabIndex="0" Width="100%"
                ...
                <ajaxToolkit:TabPanel ID="tc_observaciones" OnDemandMode="Once" runat="server" Width="100%"
                    Height="100%">
                    <HeaderTemplate>
                        <div class="tab_header" id="dividentificacion" onclick="CargarPestana('frmPlanoperativo','FramePlanOperativoInterventoria.aspx?codAspecto=1')">
                ...
                <ajaxToolkit:TabPanel ID="tc_generales" runat="server" Width="100%" Height="100%">
                    <HeaderTemplate>
                        <div class="tab_header" onclick="CargarPestana('frmnomina','FrameNominaInter.aspx?codAspecto=2')">
                            <span>Nomina</span>
                        </div>
                    </HeaderTemplate>
                    <ContentTemplate>
                ...
                <ajaxToolkit:TabPanel ID="tc_frmcomercial" runat="server" Width="100%" Height="100%">
                    <HeaderTemplate>
                        <div class="tab_header" onclick="CargarPestana('frmproduccion','FrameProduccionInter.aspx?codAspecto=3')">
                ...
                <ajaxToolkit:TabPanel ID="tc_tecnico" runat="server" Width="100%" Height="100%">
                    <HeaderTemplate>
                        <div class="tab_header" onclick="CargarPestana('frmventas','FrameVentasInter.aspx?codAspecto=4')">
                            <span>Ventas</span>
                        </div>
                    </HeaderTemplate>
                    <ContentTemplate>
