<%@ Page Language="C#" MasterPageFile="~/Master.master"  EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ProyectoAcreditacion.aspx.cs" Inherits="Fonade.FONADE.Administracion.ProyectoAcreditacion" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="bodyContentPlace">
    <asp:Panel ID="divCuerpoPrograma" runat="server">
        <h1>
            <label>ACREDITAR PLAN DE NEGOCIO</label>
        </h1>
        <table>
            <tr>
                <td colspan="2"><asp:Label ID="mNomConvocatoria" runat="server" Text=""></asp:Label></td>
            </tr>
            <tr>
                <td colspan="2">UNIDAD:&nbsp; <asp:Label ID="mNomUnidadEmprendimiento" runat="server" Text=""></asp:Label></td>
            </tr>
            <tr>
                <td>ASESOR LIDER:&nbsp; <asp:LinkButton ID="mAsesorLider" runat="server" Text="" OnClick="mAsesorLider_Click"></asp:LinkButton></td>
                <td>ASESOR:&nbsp; <asp:LinkButton ID="mAsesor" runat="server" Text="" OnClick="mAsesor_Click"></asp:LinkButton></td>
            </tr>
        </table>
        <br />
        <hr />
        ...
        <table>
            ...
            <tr>
                <td>Fecha de aval:(dd/mm/aaaa)</td>
                <td>
        ...
        <table>
            <tr>
                <td><asp:LinkButton ID="lnknotificaciones" runat="server" Text="Ver Notificaciones Enviadas" OnClick="lnknotificaciones_Click"></asp:LinkButton></td>
                <td style="text-align:right;">#Radicación CRIF</td>
                <td>
                <asp:TextBox ID="txtradificacion" runat="server" Width="150px"></asp:TextBox></td>
                <td><asp:LinkButton ID="lnkvertodos" runat="server" Text="Ver todos" OnClick="lnkvertodos_Click"></asp:LinkButton></td>
            </tr>
            <tr>
                <td colspan="4" style="text-align:right;">
                    <asp:Button ID="btnguardar" runat="server" Text="Guardar" OnClick="btnguardar_Click" OnClientClick="return confirm('¿Desea guardar la información?')" />
                </td>
            </tr>
        </table>
        <br />
            ...
            <table>
                ...
                <tr>
                    <td style="text-align:center;">
                        <asp:TextBox ID="txtobservacionproyecto" runat="server" Text="" TextMode="MultiLine" Width="80%" Height="100px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                <td style="text-align:right;">
                    <asp:Button ID="btnfinalizar" runat="server" Text="Finalizar Acreditación" OnClick="btnfinalizar_Click" OnClientClick="return confirm('¿Desea finalizar la acreditación?')" />
                </td>
            </tr>
            </table>
        </asp:Panel>
