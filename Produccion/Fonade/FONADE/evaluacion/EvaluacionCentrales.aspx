                            ...
                            <tr>
                                ...
                                <td>
                                    <div id="div_Post_It1" runat="server" visible="false">
                                        <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="CentralesRiesgo" _txtTab="1" />
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td class="auto-style10">
                        <table width="100%">
                            <tr>
                                ...
                                <td valign="baseline">
                                    <asp:TextBox runat="server" ID="txt_fechareporte" Text="" Enabled="false" BackColor="White"></asp:TextBox>&nbsp;
