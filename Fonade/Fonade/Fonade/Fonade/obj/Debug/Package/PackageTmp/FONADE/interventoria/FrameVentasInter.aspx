    ...
    <asp:Panel ID="pnlPrincipal" runat="server" Visible="true">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right">
                    <uc1:Post_It ID="Post_It2" runat="server" _txtCampo="PlanOperativo" _txtTab="1" />
                </td>
                <td align="left" colspan="3">
                    <%--Campo para el botón--%>
                            ...
                            <td valign="top" rowspan="2">
                                <div style="width: 418px; overflow: scroll; overflow-x: hidden; overflow-y: hidden;
                                    ...
                                    <asp:GridView ID="gv_productos" runat="server" Width="400px" AutoGenerateColumns="false"
                                        CssClass="Grilla" AllowPaging="True" OnPageIndexChanging="gv_productos_PageIndexChanging"
                                        OnRowCommand="gv_productos_RowCommand" OnRowDataBound="gv_productos_RowDataBound">
                                        <PagerStyle CssClass="Paginador" />
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblactividaPOI" Visible="False" Text='<%# Eval("VentasID") %>' />
                                                    <asp:Image ID="imgeditar" ImageUrl="../../Images/icoBorrar.gif" runat="server" Style="cursor: pointer;"
                                                        actividad='<%# Eval("id_ventas") %>' proyecto='<%= CodProyecto %>'></asp:Image>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Ventas en Aprobación" HeaderStyle-Width="160px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkmostrar_aprobacion" runat="server" CausesValidation="False"
                                                            CommandArgument='<%# Eval("id_ventas") %>' CommandName="mostrar" Text="Mostrar" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                ...
                                <div style="width: 380px; overflow: auto">
                                    ...
                                    <asp:GridView ID="gv_Detallesproductos" runat="server" Width="3380px" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("emprendedor2") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("fondo3") %>'></asp:Label>
                                                    <asp:Label ID="fondo3F" runat="server" Text='<%# Bind("fondo3") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("emprendedor3") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("fondo4") %>'></asp:Label>
                                                    <asp:Label ID="fondo4F" runat="server" Text='<%# Bind("fondo4") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("emprendedor4") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label8" runat="server" Text='<%# Bind("fondo5") %>'></asp:Label>
                                                    <asp:Label ID="fondo5F" runat="server" Text='<%# Bind("fondo5") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("emprendedor5") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("emprendedor6") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label11" runat="server" Text='<%# Bind("emprendedor6") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label12" runat="server" Text='<%# Bind("fondo7") %>'></asp:Label>
                                                    <asp:Label ID="fondo7F" runat="server" Text='<%# Bind("fondo7") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label13" runat="server" Text='<%# Bind("emprendedor7") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label14" runat="server" Text='<%# Bind("fondo8") %>'></asp:Label>
                                                    <asp:Label ID="fondo8F" runat="server" Text='<%# Bind("fondo8") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label15" runat="server" Text='<%# Bind("emprendedor8") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label16" runat="server" Text='<%# Bind("fondo9") %>'></asp:Label>
                                                    <asp:Label ID="fondo9F" runat="server" Text='<%# Bind("fondo9") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label17" runat="server" Text='<%# Bind("emprendedor9") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label18" runat="server" Text='<%# Bind("fondo10") %>'></asp:Label>
                                                    <asp:Label ID="fondo10F" runat="server" Text='<%# Bind("fondo10") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label19" runat="server" Text='<%# Bind("emprendedor10") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label20" runat="server" Text='<%# Bind("fondo11") %>'></asp:Label>
                                                    <asp:Label ID="fondo11F" runat="server" Text='<%# Bind("fondo11") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label21" runat="server" Text='<%# Bind("emprendedor11") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label22" runat="server" Text='<%# Bind("fondo12") %>'></asp:Label>
                                                    <asp:Label ID="fondo12F" runat="server" Text='<%# Bind("fondo12") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox23" runat="server" Text='<%# Bind("emprendedor12") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label23" runat="server" Text='<%# Bind("emprendedor12") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label24" runat="server" Text='<%# Bind("fondo13") %>'></asp:Label>
                                                    <asp:Label ID="fondo13F" runat="server" Text='<%# Bind("fondo13") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox24" runat="server" Text='<%# Bind("emprendedor13") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label25" runat="server" Text='<%# Bind("emprendedor13") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label26" runat="server" Text='<%# Bind("fondo14") %>'></asp:Label>
                                                    <asp:Label ID="fondo14F" runat="server" Text='<%# Bind("fondo14") %>' Visible="False" />
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox25" runat="server" Text='<%# Bind("emprendedor14") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label27" runat="server" Text='<%# Bind("emprendedor14") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ventas">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox28" runat="server" Text='<%# Bind("fondoTotal") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label28" runat="server" Text='<%# Bind("fondoTotal") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Ingreso">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox29" runat="server" Text='<%# Bind("emprendedorTotal") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="Label29" runat="server" Text='<%# Bind("emprendedorTotal") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="130px" />
                                            </asp:TemplateField>
                                        </Columns>
