...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="bodyContentPlace">
    ...
    <asp:Panel ID="pnl_Administradores" runat="server">
        ...
        <asp:GridView ID="gv_administradores" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            AllowSorting="True" OnRowDataBound="gv_administradores_RowDataBound" OnDataBound="gv_administradores_DataBound"
            OnRowCreated="gv_administradores_RowCreated" OnPageIndexChanging="gv_administradores_PageIndexChanged"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Nombres" SortExpression="Nombres">
                    <ItemTemplate>
                        <asp:HyperLink ID="hl_nombre" runat="server" NavigateUrl='<%# "AdministrarUsuarios.aspx?Accion=Editar&CodContacto="+ Eval("Id_contacto") %>'
    ...
    <asp:Panel ID="pnl_crearEditar" runat="server">
        <asp:Table ID="tbl_infousuario" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell>Identificación:</asp:TableCell><asp:TableCell>
                    ...
                    <asp:TextBox ID="tb_no" runat="server" />
                    <br />
        ...
        <asp:Button ID="btn_crearActualizar" OnClick="btn_crearActualizar_onclick" runat="server"
            Text="Actualizar" /></asp:TableCell>
