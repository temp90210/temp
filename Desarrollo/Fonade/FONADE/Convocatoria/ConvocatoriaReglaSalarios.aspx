<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConvocatoriaReglaSalarios.aspx.cs" Inherits="Fonade.FONADE.Convocatoria.ConvocatoriaReglaSalarios" MasterPageFile="~/Emergente.Master" %>
              ...
              <tr>
                ...
                <td colspan="5" align="center" class="style26">
                    ...
                    <asp:Button ID="btn_cerrar" runat="server" Text="Cerrar" 
                        onclick="btn_cerrar_Click" CausesValidation="False" />
                  </td>
                <td class="style26"></td>
              </tr>
            </table>
