<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CatalogoNominaPOInterventoria.aspx.cs"
    Inherits="Fonade.FONADE.evaluacion.CatalogoNominaPOInterventoria" %>
    ...
    <div>
        <table class="auto-style1">
            ...
            <tr id="tr_mes" runat="server">
                ...
                <td>
                    <asp:TextBox ID="txt_mes" runat="server" ValidationGroup="accionar" Width="250px"></asp:TextBox>
                </td>
            </tr>
            <tr id="tr_cargo" runat="server">
                ...
                <td>
                    <asp:TextBox ID="txt_cargo" runat="server" ValidationGroup="accionar" Width="250px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="text-align: center">
            ...
            <tr id="tr_observ_inter" runat="server">
                ...
                <td>
                    <asp:TextBox ID="txt_observ_interventor" runat="server" ValidationGroup="accionar"
                        Width="250px" TextMode="MultiLine" Rows="7"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" class="auto-style2">
                    ...
                    <asp:Label ID="lbl_tipoReq_Enunciado" runat="server" BackColor="#000066" ForeColor="White"
                        Text="REQUERIMIENTOS DE RECURSOS POR MES" Width="100%"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="text-align: center">
                ...
                <td style="text-align: center">
                    <asp:Label ID="Label7" runat="server" Text="Prestaciones:"></asp:Label>
