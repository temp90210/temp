        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    CodInstitucionNueva = Session["CodInstitucionNueva"] != null ? CodInstitucionNueva = Convert.ToInt32(Session["CodInstitucionNueva"].ToString()) : 0;
                    CodCiudad_JefeUnidad = Session["CodCiudad_JefeUnidad"] != null ? CodInstitucionNueva = Convert.ToInt32(Session["CodCiudad_JefeUnidad"].ToString()) : 0;
                    CodDepartamento_JefeUnidad = Session["CodDepartamento_JefeUnidad"] != null ? CodInstitucionNueva = Convert.ToInt32(Session["CodDepartamento_JefeUnidad"].ToString()) : 0;
                    CodJefeUnidadSeleccionado = Session["CodNuevoJefe_Seleccionado"] != null ? CodJefeUnidadSeleccionado = Convert.ToInt32(Session["CodNuevoJefe_Seleccionado"].ToString()) : 0;
        ...
        protected void btn_enviar_cambio_jefe_unidad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (validado.Trim() == "")
                {
                    ...
                    //try { CodJefeUnidadSeleccionado = Convert.ToInt32(Session["CodNuevoJefe_Seleccionado"].ToString()); }
                    //catch { return; } 
                    #endregion
        ...
        protected void lnk_enviar_Click(object sender, EventArgs e)
        {
            ...
            switch (lnk_sender.CommandName)
            {
                case "SINROL":
                    ...
                    Session["CodNuevoJefe_Seleccionado"] = ID;
        ...
        protected void btn_crearJefeUnidad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (sql_1.Rows.Count == 0)
                {
                    ...
                    Session["CodNuevoJefe_Seleccionado"] = sql_2.Rows[0]["Id_Contacto"].ToString();
