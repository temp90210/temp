        ...
        <ContentTemplate>
            <asp:Panel ID="principal" runat="server">
                ...
                <div id="contenido">
                    ...
                    <asp:GridView ID="gv_informesinterventoria" runat="server" CssClass="Grilla" EmptyDataText="Usted no ha generado Informes de Visitas."
                        ...
                        <Columns>
                            <asp:BoundField DataField="Id_Informe" Visible="false" />
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="lbl_numero" runat="server" Text='<%# Bind("NUM") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <EmptyDataTemplate>
                            Usted no ha generado Informes de Visitas.</EmptyDataTemplate>
                    </asp:GridView>
