...
namespace Fonade.FONADE.interventoria
{
    public partial class CatalogoCriterioDetalle : Negocio.Base_Page
    {
        ...
        {
            CodCriterio = Convert.ToInt32(Session["id_InterventorInformeFinalCriterio"]);
        ...
        protected void gvcCriterioPageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            gvcCriterio.DataSource = Session["dtAmbito"];
            gvcCriterio.DataBind();
        }
        ...
        protected void gvcCriterioRowCommand(object sender, GridViewCommandEventArgs e)
        {
            switch (e.CommandName.ToString())
            {
                case "editacontacto":
                    ...
                    Session["Id_InterventorInformeFinalItem"] = e.CommandArgument.ToString();
                    CodCriterio = Convert.ToInt32(Session["Id_InterventorInformeFinalItem"]);
                    llenarModificacion();
                    llenarTipoVerificacion(ddlTipoVerificacion1);
            ...
            try
            {
                ...
                if (caso == "Update")
                {
                    ...
                    txtSQL = " Update InterventorInformeFinalItem set NomInterventorInformeFinalItem = '" + txtNomUpd.Text + "' , " +
                             ...
                             " WHERE Id_InterventorInformeFinalItem = " + Session["Id_InterventorInformeFinalItem"].ToString();
        ...
        protected void btn_actualizar_Click(object sender, EventArgs e)
        {
            ...
            { validarInserUpdate("Create", 0, Convert.ToInt32(ddlTipoVerificacion.SelectedValue), txt_Nombre.Text); lbltitulo.Text = "Cumplimiento a Verificar"; }
        }
        ...
        protected void llenarModificacion()
        {
            try
            {
                var queryContacto = (from x in consultas.Db.InterventorInformeFinalItems
                                     ...
                                     select new { x, x2.Id_InterventorInformeFinalCriterio }).FirstOrDefault();
        ...
        protected void btn_update_Click(object sender, EventArgs e)
        {
            ...
            { insertupdateCriterio("Update", CodCriterio, Convert.ToInt32(ddlTipoVerificacion1.Text), txtNomUpd.Text); lbltitulo.Text = "Cumplimiento a Verificar"; }
        }

        protected void btn_delete_Click(object sender, EventArgs e)
        {
            insertupdateCriterio("Delete", CodCriterio, Convert.ToInt32(ddlTipoVerificacion1.Text), txtNomUpd.Text);
        }
    }
}