        ...
        <ContentTemplate>
            <table width="98%" border="0">
                ...
                <tr id="tr_Departamento" runat="server" visible="false">
                    ...
                    <td class="style39" valign="baseline">
                        Departamento:
                    </td>
                ...
                <asp:Panel ID="pnl_exp_interventor" runat="server" Visible="false">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style34">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style34">
                            Sector Principal de Interventoría:
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style34">
                            Experiencia en el Sector Principal:
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style34">
                            Sector Secundario de Interventoría:
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style34">
                            Experiencia en el Sector Secundario:
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
            ...
            <asp:Panel ID="tb_PanelAsesor" runat="server">
                <table width="98%" border="0">
                    ...
                    <tr>
                        ...
                        <td class="style33" valign="baseline">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style35">
                            Experiencia e Interes
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
        ...
        <ContentTemplate>
            <asp:Panel ID="tb_PanelJefeUnidad" runat="server">
                <table width="98%" border="0">
                    ...
                    <tr>
                        <td colspan="4" class="style35" style="font-weight: 700; font-size: 10pt">
    ...
    <asp:UpdatePanel ID="PanelEmprendedor" runat="server" Visible="false" Width="98%"
        ...
        <ContentTemplate>
            <asp:Panel ID="tb_PanelEmprendedor" runat="server">
                <table width="98%" border="0">
                    <tr>
                        <td colspan="4" class="style47" style="font-weight: 700; font-size: 10pt">
                            Datos Personales
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="style25" valign="baseline">
                            <asp:ImageButton ID="Image1" runat="server" Height="20px" ImageUrl="~/Images/adjuntarK.png"
                                Width="22px" ImageAlign="AbsBottom" OnClick="Image1_Click" />
            ...
            <asp:Panel ID="tb_PanelGerenteAdmin" runat="server">
                <table width="98%" border="0">
                    ...
                    <tr>
                        ...
                        <td class="style55" valign="baseline">
                            Clave:
                        </td>
                        <td class="style53" valign="baseline">
                            ••••••••&nbsp;
            ...
            <asp:Panel ID="tb_PanelEvaluador" runat="server">
                <table width="98%" border="0">
                    ...
                    <tr>
                        ...
                        <td class="auto-style1" valign="baseline">
                            Persona:
                        </td>
                        <td class="style24" valign="baseline">
                    ...
                    <tr>
                        ...
                        <td class="auto-style1" valign="baseline">
                            Planes de negocio que puede atender:
                        </td>
                        <td class="style24" valign="baseline">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style35">
                            Sector Principal de Evaluación
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
                    ...
                    <tr>
                        <td colspan="4" style="font-weight: 700; font-size: 10pt" class="style35">
                            Sector Secundario de Evaluación
                        </td>
                    </tr>
                    <tr>
                        <td class="style22">
