...
namespace Fonade.FONADE.interventoria
{
    public partial class AdicionarInformePresupuestalProyecto : Negocio.Base_Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CodInforme = Session["CodInforme"] != null && !string.IsNullOrEmpty(Session["CodInforme"].ToString()) ? Session["CodInforme"].ToString() : "0";
        ...
        private void guardaBimestrl()
        {
            ...
            if (infoTanlaAux.Rows.Count > 0)
            {
                txtSQL = @"Insert into InformePresupuestal (NomInformePresupuestal,codinterventor,codempresa,Estado,Periodo,Fecha) " +
                    "values ('" + lblEmpresa.Text + " " + NomPeriodo + "'," + usuario.IdContacto + "," + CodEmpresa + ",0," + Periodo + ",'" + fecha + "')";
                ...
                if (infoTanlaAux.Rows.Count > 0) { Session["CodInforme"] = CodEmpresa; }
            }
        }
        ...
        protected void btn_imprimir_Click(object sender, EventArgs e)
        {
            ...
            Session["CodInforme"] = CodInforme; //idInformePresupuestal
            Session["CodEmpresa"] = CodEmpresa;
            Session["Periodo"] = dd_Periodo.SelectedValue;
