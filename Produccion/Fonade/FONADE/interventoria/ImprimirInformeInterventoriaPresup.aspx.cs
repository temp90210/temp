...
{
    public partial class ImprimirInformeInterventoriaPresup : Negocio.Base_Page
    {
        String CodEmpresa;
        ...
        {
            CodEmpresa = Session["CodEmpresa"] != null ? CodEmpresa = Session["CodEmpresa"].ToString() : "0";
            idInformePresupuestal = Session["INF_idInformePresupuestal"] != null ? idInformePresupuestal = Session["INF_idInformePresupuestal"].ToString() : "0";

            if (!IsPostBack)
            {
                if (idInformePresupuestal == "0")
                { idInformePresupuestal = Session["idInformePresupuestal"] != null ? idInformePresupuestal = Session["idInformePresupuestal"].ToString() : "0"; }

                if (CodEmpresa != "0" && idInformePresupuestal != "0")
        ...
        /// 17/07/2014.
        /// Generar HTML imprimible del informe presupuestal.
        /// </summary>
        private void GenerarInforme_Impresion()
        {
            ...
            try
            {
                ...
                lbl_informe.Text = lbl_informe.Text + "<table width='640'  border='0' cellspacing='0' cellpadding='0'>" +
                                                              ...
                                                              "<tr> " +
                                                              "  <td colspan='7'><div align='center' class='Titulo'>FORMATO 01A</div></td>" +
                                                              "</tr>" +
                                                              "<tr> " +
                                                              "  <td colspan='7'><div align='center' class='Titulo'>INFORME DE SEGUIMIENTO PRESUPUESTAL DE INTERVENTORIA</div></td>" +
                                                              "</tr>" +
                                                              "<tr> " +
                ...
                if (RSPeriodo.Rows.Count > 0)
                {
                    ...
                    try { Fecha = DateTime.Parse(RSPeriodo.Rows[0]["Fecha"].ToString()); }
                    catch { Fecha = new DateTime(); lbl_informe.Text = lbl_informe.Text + Fecha; }
                ...
                foreach (DataRow row_RS in RS.Rows)
                {
                    ...
                    lbl_informe.Text = lbl_informe.Text + "<tr> " +
                        ...
                        //"  </td>" +
                                                          "</tr>	" +
                                                          "  <tr> " +
                                                          "    <td colspan='7' bgcolor='#B0B0B0' class='tituloTabla'>" + NomTipoAmbito + "</td>" +
                                                          "  </tr>";
                    ...
                    foreach (DataRow row_RSAux in RSAux.Rows)
                    {
                        ...
                        lbl_informe.Text = lbl_informe.Text + "<tr> " +
                                                                          "    <td align='center' bgcolor='#CCCCCC'>" + row_RSAux["id_Ambito"].ToString() + "</td>" +
                                                                          "    <td bgcolor='#CCCCCC' class='Titulo'>" + row_RSAux["NomAmbito"].ToString() + "</td>" +
                        ...
                        txtSQL = " SELECT * FROM AmbitoDetalle WHERE (CodInforme IN (SELECT id_informepresupuestal FROM informepresupuestal " +
                                 " WHERE codempresa = " + CodEmpresa + " AND id_informepresupuestal <>" + idInformePresupuestal +
                                 " AND periodo<" + Periodo + ")) AND (CodAmbito = " + row_RSAux["id_Ambito"].ToString() + ") AND (Seguimiento = 1)";
                ...
                try { lbl_informe.Text = lbl_informe.Text + "              <tr class='Titulo'><td colspan=2>Dadas las condiciones en que el Contratista se viene cumpliendo o incumpliendo, con las obligaciones del contrato, el INTERVENTOR recomienda FONADE: " + "" + "<br/><br/><br/><br/></td></tr>"; }
                catch { lbl_informe.Text = lbl_informe.Text + "              <tr class='Titulo'><td colspan=2>Dadas las condiciones en que el Contratista se viene cumpliendo o incumpliendo, con las obligaciones del contrato, el INTERVENTOR recomienda FONADE: " + "" + "<br/><br/><br/><br/></td></tr>"; }
