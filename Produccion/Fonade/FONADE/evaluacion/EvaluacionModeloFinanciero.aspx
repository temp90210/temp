                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="div_Post_It1" runat="server" visible="false">
                                            <uc1:Post_It ID="Post_It1" runat="server" _txtCampo="ModeloFinanciero" _txtTab="1" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
                ...
                <table width="100%" style="height: 260px" bgcolor="White">
                    <tr>
                        <td valign="middle" align="center">
                            <table width="100%" style="border: medium solid #00468F; height: 175px; width: 640px;">
                                <tr>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td valign="middle" align="center" class="auto-style3">
                                                        <asp:HyperLink ID="HyperLink1" ImageUrl="~/Images/Download.png" runat="server" Width="264px"
                                                    ...
                                                    <td valign="middle" align="center" class="auto-style2" style="width: 50%">
                                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/upload.png"
                                                            OnClick="ImageButton2_Click" />
                                                        <br />
                                                        <asp:LinkButton ID="Button1" runat="server" Text="Subir Modelo Financiero" Width="264px"
