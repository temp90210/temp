            ...
            <tr>
                <td align='left' valign='top' width='98%'>
                    ...
                    <table cellpadding="0px" cellspacing="0px">
                        <tr>
                            <td valign="top">
                                <div style="width: 350px; overflow: scroll; overflow-x: hidden !important; border-right: silver 1px solid; height: auto !important;">
                                    <asp:GridView ID="gv_productos" runat="server" Width="400px" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblactividaPOI" Visible="False" Text='<%# Eval("ProduccionID") %>' />
                                                    <asp:Image ID="imgeditar" ImageUrl="../../Images/icoBorrar.gif" runat="server" Style="cursor: pointer;"
                                                        actividad='<%# Eval("id_produccion") %>' proyecto='<%= CodProyecto %>'></asp:Image>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Productos en Aprobación" HeaderStyle-Width="160px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkmostrar_aprobacion" runat="server" CausesValidation="False"
                                                            CommandArgument='<%# Eval("id_produccion") %>' CommandName="mostrar" Text="Mostrar" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
