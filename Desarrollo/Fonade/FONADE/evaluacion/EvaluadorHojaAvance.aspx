...
<body style="background-color: #fff; background-image:none!important;">
    ...
    <div>
        <asp:DataList ID="DtSeguimiento" runat="server" Width="88%" 
            ...
            <HeaderTemplate>
                <table  border="0" width="100%">
                    <tr align="center" bgcolor="#D1D8E2" class="Titulo">
                        ...
                        <td>
                            Lectura del Plan de negocio
                        </td>
                        <td>
                            Solicitud de información al emprendedor
                        </td>
                        <td colspan="23">
                            <div align="center">
                    ...
                    <tr align="center" bgcolor="#EDEFF3" class="Titulo">
                        ...
                        <td>
                            Estrategias y garantias de comercialización
                        </td>
                        <td>
                            Identificación Mercado Objetivo
                        </td>
                        <td>
                            Identificacion y evaluacion de canales
                        </td>
                        <td>
                            Proyeccion de ventas
                        </td>
                        <td>
                            Caracterizacion Técnica del Producto o Servicio
                        </td>
                        <td>
                            Definición del proceso de producción a implementar e indices técnicos
                        </td>
                        <td>
                            Identificación y valoración de los requerimientos en equipamiento y materiales y
                            suministros
                        </td>
                        <td>
                        ...
                        <td>
                            Analisis en los tramites y requisitos legales para la puesta en marcha de la empresa
                        </td>
                        <td>
                            Compromisos institucionales privados o publicos
                        </td>
                        <td>
                            Organización empresarial propuesta
                        </td>
                        <td>
                            Cunatificacion de la inversion requerida
                        </td>
                        <td>
                        ...
                        <td>
                            contempla o no el manejo ambiental
                        </td>
                        <td>
                            &nbsp;
                        </td>
         ...
         <p align="center"> <asp:Label ID="lblmensaje" runat="server" Font-Size="XX-Large" Visible="False"
                                              Text="No se encontraron  Datos"/> </p>
    </div>
    </form>
</body>
</html>
